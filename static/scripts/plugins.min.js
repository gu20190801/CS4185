! function(e) {
    ...
    var t = "animsition",
        i = {
            init: function(n) {
                ...
                return o || !(n.browser.length > 0) || o && this.length ? (i.optionCheck.call(this, n) && e("." + n.overlayClass).length <= 0 && i.addOverlay.call(this, n), n.loading && e("." + n.loadingClass).length <= 0 && i.addLoading.call(this, n), this.each(function() {
                    var o = this,
                        a = e(this),
                        s = e(window),
                        r = e(document);
                    a.data(t) || (n = e.extend({}, n), a.data(t, {
                        options: n
                    }), n.timeout && i.addTimer.call(o), n.onLoadEvent && s.on("load." + t, function() {
                        i.settings.timer && clearTimeout(i.settings.timer), i.in.call(o)
                    }), s.on("pageshow." + t, function(e) {
                        e.originalEvent.persisted && i.in.call(o)
                    }), s.on("unload." + t, function() {}), r.on("click." + t, n.linkElement, function(t) {
                        t.preventDefault();
                        var n = e(this),
                            a = n.attr("href");
            ...
            optionCheck: function(t) {
                var n = e(this);
                return !(!t.overlay && !n.data(i.settings.data.overlay))
            },
            animationCheck: function(i, n, o) {
                var a = e(this),
                    ...
                    r = typeof i,
                    l = !n && "number" === r,
                    c = n && "string" === r && i.length > 0;
                return l || c ? i = i : n && o ? i = s.inClass : !n && o ? i = s.inDuration : n && !o ? i = s.outClass : n || o || (i = s.outDuration), i
            },
            in: function() {
                var n = this,
                    o = e(this),
                    ...
                    c = i.animationCheck.call(n, r, !0, !0),
                    p = i.optionCheck.call(n, a),
                    d = o.data(t).outClass;
                a.loading && i.removeLoading.call(n), d && o.removeClass(d), p ? i.inOverlay.call(n, c, l) : i.inDefault.call(n, c, l)
            },
            ...
            inOverlay: function(n, o) {
                ...
                a.css({
                    opacity: 1
                }).trigger(i.settings.events.inStart), e(s.overlayParentElement).children("." + s.overlayClass).css({
            ...
            out: function(n, o) {
                var a = this,
                    ...
                    p = n.data(i.settings.data.outDuration),
                    d = s.data(i.settings.data.outDuration),
                    u = l ? l : c,
                    h = p ? p : d,
                    f = i.animationCheck.call(a, u, !0, !1),
                    g = i.animationCheck.call(a, h, !1, !1),
                    m = i.optionCheck.call(a, r);
                s.data(t).outClass = f, m ? i.outOverlay.call(a, f, g, o) : i.outDefault.call(a, f, g, o)
            },
            outDefault: function(n, o, a) {
                ...
                s.css({
                    ...
                    s.trigger(i.settings.events.outEnd), r.transition(a)
                })
            },
            outOverlay: function(n, o, a) {
                var s = this,
                    r = e(this),
                    l = r.data(t).options,
                    c = r.data(i.settings.data.inClass),
                    p = i.animationCheck.call(s, c, !0, !0);
                e(l.overlayParentElement).children("." + l.overlayClass).css({
                    "animation-duration": o + 1 + "ms"
                }).removeClass(p).addClass(n).trigger(i.settings.events.outStart).animateCallback(function() {
                    r.trigger(i.settings.events.outEnd), l.transition(a)
                })
            },
            destroy: function() {
    ...
    function(e) {
        ...
        var t = {
            init: function(t) {
                ...
                return this.each(function() {
                    var t = {
                        init: function() {
                            var i = e(this);
                            t.prepareHoverfolio.apply(i), t.buildHoverfolio.apply(i), n.activeIndex > 0 && t.activeItem.apply(i)
                        },
                        prepareHoverfolio: function() {
                            var t = e(this);
                            t.addClass("vlt-hoverfolio"), t.wrapInner('<div class="vlt-hoverfolio-inner">'), t.find("a").addClass("vlt-hoverfolio-link"), t.append('<div class="vlt-hoverfolio-image"><img src="" alt=""></div>')
                        },
                        buildHoverfolio: function() {
                            var t = e(this),
                                o = t.find("a.vlt-hoverfolio-link"),
                                a = t.find(".vlt-hoverfolio-image img");
                            o.on("mouseenter", function() {
                                t.addClass("hovered");
                                var o = e(this).data("image");
                                if (o != i) {
                                    if (a.attr("src", o), 1 == n.randomWidth) {
                                        var s = Math.floor(Math.random() * (n.randomInterval[1] - n.randomInterval[0] + 1)) + n.randomInterval[0];
                                        a.css("max-width", s + "%")
                                    } else a.css({
                                        "max-width": n.imageMaxWidth + "%",
                                        "max-height": n.imageMaxHeight + "%"
                                    });
                                    a.on("load", function() {
                                        a.stop().animate({
                                            opacity: 1
                        ...
                        activeItem: function() {
                            e(this).find("a.vlt-hoverfolio-link").eq(n.activeIndex - 1).trigger("mouseenter")
                        }
                    };
                    t.init.apply(this)
                })
            ...
            destroy: function() {
                this.removeClass("vlt-hoverfolio hovered"), this.find("a").removeClass("vlt-hoverfolio-link"), this.find(".vlt-hoverfolio-image").remove()
            }
        };
        e.fn.hoverfolio = function(i) {
            return t[i] ? t[i].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof i && i ? void e.error("Method: " + i + " does not exists. jQuery.hoverfolio") : t.init.apply(this, arguments)
        }
    }(jQuery),
    function(e, t) {
        ...
        return t.on = function(e, t) {
            ...
            if (i && i.length) {
                ...
                for (var a = this._onceEvents && this._onceEvents[e]; o;) {
                    var s = a && a[o];
                    s && (this.off(e, o), delete a[o]), o.apply(this, t), n += s ? 0 : 1, o = i[n]
                }
                return this
            }
        }, e
    ...
    function(e, t) {
        ...
        function o(e, t, a) {
            return this instanceof o ? ("string" == typeof e && (e = document.querySelectorAll(e)), this.elements = n(e), this.options = i({}, this.options), "function" == typeof t ? a = t : i(this.options, t), a && this.on("always", a), this.getImages(), r && (this.jqDeferred = new r.Deferred), void setTimeout(function() {
                this.check()
    ...
    function(e) {
        ...
        function t(e) {
            var t = ["O", "Moz", "ms", "Ms", "Webkit"],
                i = t.length;
            if (void 0 !== r.style[e]) return !0;
            for (e = e.charAt(0).toUpperCase() + e.substr(1); --i > -1 && void 0 === r.style[t[i] + e];);
            return i >= 0
        }

        function i() {
            a = e.innerWidth || document.documentElement.clientWidth, s = e.innerHeight || document.documentElement.clientHeight
        }
        ...
        function o(t) {
            e.requestAnimationFrame(function() {
                "scroll" !== t.type && i();
                for (var e = 0, n = m.length; e < n; e++) "scroll" !== t.type && (m[e].coverImage(), m[e].clipContainer()), m[e].onScroll()
            })
        }
        ...
        var a, s, r = document.createElement("div"),
            l = t("transform"),
            c = t("perspective"),
            p = navigator.userAgent,
            d = p.toLowerCase().indexOf("android") > -1,
            u = /iPad|iPhone|iPod/.test(p) && !e.MSStream,
            h = p.toLowerCase().indexOf("firefox") > -1,
            f = p.indexOf("MSIE ") > -1 || p.indexOf("Trident/") > -1 || p.indexOf("Edge/") > -1,
            g = document.all && !e.atob;
        i();
        var m = [],
            v = function() {
                function e(e, i) {
                    ...
                    if (o.$item = e, o.defaults = {
                        ...
                        onDestroy: null,
                        onCoverImage: null
                    }, n = JSON.parse(o.$item.getAttribute("data-jarallax") || "{}"), o.options = o.extend({}, o.defaults, n, i), !(!l || d && o.options.noAndroid || u && o.options.noIos)) {
        ...
        v.prototype.css = function(t, i) {
            ...
            for (var o = 0, a = t.$item; null !== a && a !== document && 0 === o;) {
                var s = t.css(a, "-webkit-transform") || t.css(a, "-moz-transform") || t.css(a, "transform");
                s && "none" !== s && (o = 1, t.css(t.image.$container, {
            ...
            for (var e = this, t = 0, i = m.length; t < i; t++)
                if (m[t].instanceID === e.instanceID) {
                    m.splice(t, 1);
                    break
            ...
            if (e.image.width && e.image.height) {
                var t = e.image.$container.getBoundingClientRect(),
                    ...
                    h = 0,
                    f = 0;
                c && (p = l < 0 ? l * Math.max(n, s) : l * (n + s), l > 1 ? u = Math.abs(p - s) : l < 0 ? u = p / l + Math.abs(p) : u += Math.abs(s - n) * (1 - l), p /= 2), d = u * a / r, d < i && (d = i, u = d * r / a), c ? (h = o + (i - d) / 2, f = (s - u) / 2) : (h = (i - d) / 2, f = (n - u) / 2), "absolute" === e.image.position && (h -= o), e.parallaxScrollDistance = p, e.css(e.image.$item, {
                    width: d + "px",
                    height: u + "px",
                    marginLeft: h + "px",
                    marginTop: f + "px"
            ...
            if (t.image.width && t.image.height) {
                var i = t.$item.getBoundingClientRect(),
                    ...
                    l = i;
                if (t.options.elementInViewport && (l = t.options.elementInViewport.getBoundingClientRect()), t.isElementInViewport = l.bottom >= 0 && l.right >= 0 && l.top <= s && l.left <= a, e || t.isElementInViewport) {
                    var c = Math.max(0, n),
                        p = Math.max(0, o + n),
                        d = Math.max(0, -n),
                        u = Math.max(0, n + o - s),
                        h = Math.max(0, o - (n + o - s)),
                        f = Math.max(0, -n + s - o),
                        g = 1 - 2 * (s - n) / (s + o),
                        m = 1;
                    if (o < s ? m = 1 - (d || u) / o : p <= s ? m = p / s : h <= s && (m = h / s), "opacity" !== t.options.type && "scale-opacity" !== t.options.type && "scroll-opacity" !== t.options.type || (r.transform = "", r.opacity = m), "scale" === t.options.type || "scale-opacity" === t.options.type) {
                        var v = 1;
                        t.options.speed < 0 ? v -= t.options.speed * m : v += t.options.speed * (1 - m), r.transform = "scale(" + v + ")"
                    }
                    if ("scroll" === t.options.type || "scroll-opacity" === t.options.type) {
                        var b = t.parallaxScrollDistance * g;
                        "absolute" === t.image.position && (b -= n), r.transform = "translateY(" + b + "px)"
                    }
        ...
        var b = function(e) {
            ...
            var t, i = arguments[1],
                ...
                a = 0;
            for (a; a < o; a++)
                if ("object" == typeof i || void 0 === i ? e[a].jarallax || (e[a].jarallax = new v(e[a], i)) : e[a].jarallax && (t = e[a].jarallax[i].apply(e[a].jarallax, n)), void 0 !== t) return t;
            return e
        };
        b.constructor = v;
        var w = e.jarallax;
        if (e.jarallax = b, e.jarallax.noConflict = function() {
            return e.jarallax = w, this
        ...
        n(e, "DOMContentLoaded", function() {
            b(document.querySelectorAll("[data-jarallax], [data-jarallax-video]"))
        })
    }(window),
    function(e) {
        e.fn.collagePlus = function(t) {
            function i(t, i, o, a) {
                for (var s = o.padding * (t.length - 1) + t.length * t[0][3], r = o.albumWidth - s, l = r / (i - s), c = s, p = i < o.albumWidth, d = 0; d < t.length; d++) {
                    var u = e(t[d][0]),
                        h = Math.floor(t[d][1] * l),
                        f = Math.floor(t[d][2] * l),
                        g = !!(d < t.length - 1);
                    o.allowPartialLastRow === !0 && p === !0 && (h = t[d][1], f = t[d][2]), c += h, !g && c < o.albumWidth && (o.allowPartialLastRow === !0 && p === !0 ? h = h : h += o.albumWidth - c), h--;
                    var m = u.is("img") ? u : u.find("img");
                    m.width(h), u.is("img") || u.width(h + t[d][3]), m.height(f), u.is("img") || u.height(f + t[d][4]), n(u, g, o), m.one("load", function(e) {
                        return function() {
                            if ("default" == o.effect) e.animate({
                                ...
                                if ("vertical" == o.direction) var t = a <= 10 ? a : 10;
                                else var t = d <= 9 ? d + 1 : 10;
            ...
            return this.each(function() {
                var n = 0,
                    ...
                    s = 1,
                    r = e(this);
                e.fn.collagePlus.defaults.albumWidth = r.width(), e.fn.collagePlus.defaults.padding = parseFloat(r.css("padding-left")), e.fn.collagePlus.defaults.images = r.children();
                var l = e.extend({}, e.fn.collagePlus.defaults, t);
                l.images.each(function(t) {
                    var r = e(this),
                        c = r.is("img") ? r : e(this).find("img"),
                        p = void 0 !== c.data("width") ? c.data("width") : c.width(),
                        d = void 0 !== c.data("height") ? c.data("height") : c.height(),
                        u = o(c);
                    c.data("width", p), c.data("height", d);
                    var h = Math.ceil(p / d * l.targetHeight),
                        f = Math.ceil(l.targetHeight);
                    a.push([this, h, f, u.w, u.h]), n += h + u.w + l.padding, n > l.albumWidth && 0 != a.length && (i(a, n - l.padding, l, s), delete n, delete a, n = 0, a = [], s += 1), l.images.length - 1 == t && 0 != a.length && (i(a, n, l, s), delete n, delete a, n = 0, a = [], s += 1)
                })
            })
    ...
    function(e, t, i, n) {
        ...
        function o(t, i, a) {
            ...
            s.obj = t, s.$obj = e(t), e.data(s.obj, "cubeportfolio", s), i.sortToPreventGaps !== n && (i.sortByDimension = i.sortToPreventGaps, delete i.sortToPreventGaps), s.options = e.extend({}, e.fn.cubeportfolio.options, i, s.$obj.data("cbp-options")), s.isAnimating = !0, s.defaultFilter = s.options.defaultFilter, s.registeredEvents = [], s.queue = [], s.addedWrapp = !1, e.isFunction(a) && s.registerEvent("initFinish", a, !0);
            var r = s.$obj.children();
            s.$obj.addClass("cbp"), (0 === r.length || r.first().hasClass("cbp-item")) && (s.wrapInner(s.obj, "cbp-wrapper"), s.addedWrapp = !0), s.$ul = s.$obj.children().addClass("cbp-wrapper"), s.wrapInner(s.obj, "cbp-wrapper-outer"), s.wrapper = s.$obj.children(".cbp-wrapper-outer"), s.blocks = s.$ul.children(".cbp-item"), s.blocksOn = s.blocks, s.wrapInner(s.blocks, "cbp-item-wrapper"), s.plugins = {}, e.each(o.plugins, function(e, t) {
                var i = t(s);
                i && (s.plugins[e] = i)
        ...
        e.extend(o.prototype, {
            ...
            wrapInner: function(e, t) {
                ...
                if (t = t || "", !(e.length && e.length < 1))
                    for (e.length === n && (e = [e]), a = e.length - 1; a >= 0; a--) {
                        for (o = e[a], s = i.createElement("div"), s.setAttribute("class", t); o.childNodes.length;) s.appendChild(o.childNodes[0]);
                        o.appendChild(s)
                    }
            },
                ...
                requestAnimationFrame(function() {
                    var o = t.find("img").map(function(t, i) {
                            if (i.hasAttribute("width") && i.hasAttribute("height")) {
                                if (i.style.width = i.getAttribute("width") + "px", i.style.height = i.getAttribute("height") + "px", i.hasAttribute("data-cbp-src")) return null;
                                if (null === n.checkSrc(i)) n.removeAttrImage(i);
                                else {
                                    var o = e("<img>");
                                    o.on("load.cbp error.cbp", function() {
                                        e(this).off("load.cbp error.cbp"), n.removeAttrImage(i)
                                    }), i.srcset ? (o.attr("sizes", i.sizes || "100vw"), o.attr("srcset", i.srcset)) : o.attr("src", i.src)
                                }
                                return null
                            }
                            return n.checkSrc(i)
                        ...
                        a = o.length;
                    return 0 === a ? void i.call(n) : void e.each(o, function(t, o) {
                        var s = e("<img>");
                        s.on("load.cbp error.cbp", function() {
                            e(this).off("load.cbp error.cbp"), 0 === --a && i.call(n)
                        }), o.srcset ? (s.attr("sizes", o.sizes), s.attr("srcset", o.srcset)) : s.attr("src", o.src)
                    })
                })
            },
            checkSrc: function(t) {
                ...
                if ("" === o) return null;
                var a = e("<img>");
                i ? (a.attr("sizes", t.sizes || "100vw"), a.attr("srcset", i)) : a.attr("src", o);
                var s = a[0];
                return s.complete && s.naturalWidth !== n && 0 !== s.naturalWidth ? null : s
            },
            display: function() {
                var e = this;
            ...
            gridAdjust: function() {
                ...
                "responsive" === t.options.gridAdjustment ? t.responsiveLayout() : (t.blocks.removeAttr("style"), t.blocks.each(function(i, n) {
                    var o = e(n).data("cbp"),
                        ...
                        s = t.columnWidthTruncate(a.right - a.left),
                        r = Math.round(a.bottom - a.top);
                    o.height = r, o.heightAndGap = r + t.options.gapHorizontal, o.width = s, o.widthAndGap = s + t.options.gapVertical
            ...
            responsiveLayout: function() {
                ...
                t.cols = t[e.isArray(t.options.mediaQueries) ? "getColumnsBreakpoints" : "getColumnsAuto"](), t.columnWidth = t.columnWidthTruncate((t.width + t.options.gapVertical) / t.cols), t.widthAvailable = t.columnWidth * t.cols, "mosaic" === t.options.layoutMode && t.getMosaicWidthReference(), t.blocks.each(function(i, n) {
                    var o, a = e(n).data("cbp"),
                        s = 1;
                    "mosaic" === t.options.layoutMode && (s = t.getColsMosaic(a.widthInitial)), o = t.columnWidth * s - t.options.gapVertical, n.style.width = o + "px", a.width = o, a.widthAndGap = o + t.options.gapVertical, n.style.height = ""
                });
                var i = [];
                t.blocks.each(function(t, n) {
                    e.each(e(n).find("img").filter("[width][height]"), function(t, n) {
                        ...
                        var a = parseInt(n.getAttribute("width"), 10),
                            s = parseInt(n.getAttribute("height"), 10),
                            r = parseFloat((a / s).toFixed(10));
                        i.push({
                            el: n,
                            width: o,
            ...
            getColumnsBreakpoints: function() {
                ...
                return e.each(i.options.mediaQueries, function(e, i) {
                    if (n >= i.width) return t = i, !1
                }), t || (t = i.options.mediaQueries[i.options.mediaQueries.length - 1]), i.triggerEvent("onMediaQueries", t.options), t.cols
            },
            ...
            resizeMainContainer: function() {
                var t, i = this,
                    a = Math.max(i.freeSpaces.slice(-1)[0].topStart - i.options.gapHorizontal, 0);
                return "alignCenter" === i.options.gridAdjustment && (t = 0, i.blocksOn.each(function(i, n) {
                    var o = e(n).data("cbp"),
                        a = o.left + o.width;
                    a > t && (t = a)
                }), i.wrapper[0].style.maxWidth = t + "px"), a === i.height ? void i.triggerEvent("resizeMainContainer") : (i.obj.style.height = a + "px", i.height !== n && (o.private.modernBrowser ? i.$obj.one(o.private.transitionend, function() {
                    i.$obj.trigger("pluginResize.cbp")
                }) : i.$obj.trigger("pluginResize.cbp")), i.height = a, void i.triggerEvent("resizeMainContainer"))
            },
            ...
            triggerEvent: function(e, t) {
                ...
                if (o.registeredEvents[e])
                    for (i = 0, n = o.registeredEvents[e].length; i < n; i++) o.registeredEvents[e][i].func.call(o, t), o.registeredEvents[e][i].oneTime && (o.registeredEvents[e].splice(i, 1), i--, n--)
            },
            addItems: function(t, i, n) {
                var a = this;
                a.wrapInner(t, "cbp-item-wrapper"), a.$ul[n](t.addClass("cbp-item-loading").css({
                    top: "100%",
                    left: 0
                })), o.private.modernBrowser ? t.last().one(o.private.animationend, function() {
                    a.addItemsFinish(t, i)
                }) : a.addItemsFinish(t, i), a.loadImages(t, function() {
                    if (a.$obj.addClass("cbp-updateItems"), "append" === n) a.storeData(t, a.blocks.length), e.merge(a.blocks, t);
                    else {
                        a.storeData(t);
                        var i = t.length;
                        a.blocks.each(function(t, n) {
                            e(n).data("cbp").index = i + t
                        }), a.blocks = e.merge(t, a.blocks)
                    }
                    a.triggerEvent("addItemsToDOM", t), a.layoutAndAdjustment(!0), a.elems && o.public.showCounter.call(a.obj, a.elems)
                })
            },
            addItemsFinish: function(t, i) {
                var n = this;
                n.isAnimating = !1, n.$obj.removeClass("cbp-updateItems"), t.removeClass("cbp-item-loading"), e.isFunction(i) && i.call(n, t), n.$obj.trigger("onAfterLoadMore.cbp", [t])
            },
            removeItems: function(t, i) {
                var n = this;
                n.$obj.addClass("cbp-updateItems"), o.private.modernBrowser ? t.last().one(o.private.animationend, function() {
                    n.removeItemsFinish(t, i)
                }) : n.removeItemsFinish(t, i), t.each(function(t, i) {
                    n.blocks.each(function(t, a) {
                        if (i === a) {
                            var s = e(a);
                            n.blocks.splice(t, 1), o.private.modernBrowser ? (s.one(o.private.animationend, function() {
                                s.remove()
                ...
                }), n.layoutAndAdjustment(!0), n.elems && o.public.showCounter.call(n.obj, n.elems)
            },
            removeItemsFinish: function(t, i) {
                var n = this;
                n.isAnimating = !1, n.$obj.removeClass("cbp-updateItems"), e.isFunction(i) && i.call(n, t)
            }
    ...
    function(e, t, i, n) {
        ...
        e.extend(o.prototype, {
            mosaicLayoutReset: function() {
                var t = this;
                t.blocksAreSorted = !1, t.blocksOn.each(function(i, n) {
                    e(n).data("cbp").pack = !1, t.options.sortByDimension && (n.style.height = "")
                }), t.freeSpaces = [{
                    leftStart: 0,
            ...
            mosaicLayout: function() {
                for (var e = this, t = 0, i = e.blocksOn.length; t < i; t++) {
                    ...
                    if (null === n) return e.mosaicLayoutReset(), e.sortBlocksToPreventGaps(), void e.mosaicLayout();
                    e.generateF1F2(n.spaceIndex, n.dataBlock), e.generateG1G2G3G4(n.dataBlock), e.cleanFreeSpaces(), e.addHeightToBlocks()
                }
            ...
            getSpaceIndexAndBlock: function() {
                ...
                return e.each(t.freeSpaces, function(n, o) {
                    ...
                    return t.blocksOn.each(function(t, r) {
                        var l = e(r).data("cbp");
                        if (l.pack !== !0) return l.widthAndGap <= a && l.heightAndGap <= s ? (l.pack = !0, i = {
                            spaceIndex: n,
                            dataBlock: l
                        }, l.leftNew = o.leftStart, l.topNew = o.topStart, !1) : void 0
                    }), !t.blocksAreSorted && t.options.sortByDimension && n > 0 ? (i = null, !1) : null === i && void 0
                }), i
            },
            generateF1F2: function(e, t) {
                ...
                i.freeSpaces.splice(e, 1), o.leftEnd > o.leftStart && o.topEnd > o.topStart && (i.freeSpaces.splice(e, 0, o), e++), a.leftEnd > a.leftStart && a.topEnd > a.topStart && i.freeSpaces.splice(e, 0, a)
            },
            generateG1G2G3G4: function(t) {
                var i = this,
                    n = [];
                e.each(i.freeSpaces, function(e, o) {
                    var a = i.intersectSpaces(o, t);
                    return null === a ? void n.push(o) : (i.generateG1(o, a, n), i.generateG2(o, a, n), i.generateG3(o, a, n), void i.generateG4(o, a, n))
                }), i.freeSpaces = n
            },
            intersectSpaces: function(e, t) {
                ...
                var n = Math.max(e.leftStart, i.leftStart),
                    ...
                    a = Math.max(e.topStart, i.topStart),
            ...
            correctSubPixelValues: function() {
                var e, t, i, n, o = this;
                for (e = 0, t = o.freeSpaces.length - 1; e < t; e++) i = o.freeSpaces[e], n = o.freeSpaces[e + 1], n.topStart - i.topStart <= 1 && (n.topStart = i.topStart)
            },
            removeNonMaximalFreeSpaces: function() {
                var t = this;
                t.uniqueFreeSpaces(), t.freeSpaces = e.map(t.freeSpaces, function(i, n) {
                    return e.each(t.freeSpaces, function(e, t) {
                        if (n !== e) return t.leftStart <= i.leftStart && t.leftEnd >= i.leftEnd && t.topStart <= i.topStart && t.topEnd >= i.topEnd ? (i = null, !1) : void 0
                    }), i
                })
            },
            uniqueFreeSpaces: function() {
                ...
                e.each(t.freeSpaces, function(t, n) {
                    e.each(i, function(e, t) {
                        if (t.leftStart === n.leftStart && t.leftEnd === n.leftEnd && t.topStart === n.topStart && t.topEnd === n.topEnd) return n = null, !1
                    }), null !== n && i.push(n)
                }), t.freeSpaces = i
            },
            addHeightToBlocks: function() {
                ...
                e.each(t.freeSpaces, function(i, n) {
                    t.blocksOn.each(function(i, o) {
                        var a = e(o).data("cbp");
                        if (a.pack === !0 && t.intersectSpaces(n, a)) {
                            n.topStart - a.topNew - a.heightAndGap === -1 && (o.style.height = a.height - 1 + "px")
                        }
                    })
                })
            },
            ...
            sortBlocks: function(t, i) {
                t.sort(function(t, n) {
                    var o = e(t).data("cbp"),
                        a = e(n).data("cbp");
                    return o[i] > a[i] ? 1 : o[i] < a[i] ? -1 : o.leftNew > a.leftNew ? 1 : o.leftNew < a.leftNew ? -1 : 0
                })
            }
        })
    ...
    function(e, t, i, n) {
        ...
        o.private = {
            publicEvents: function(t, i, n) {
                var o = this;
                o.events = [], o.initEvent = function(e) {
                    0 === o.events.length && o.scrollEvent(), o.events.push(e)
                }, o.destroyEvent = function(i) {
                    o.events = e.map(o.events, function(e, t) {
                        if (e.instance !== i) return e
                    }), 0 === o.events.length && a.off(t)
            ...
            browserInfo: function() {
                ...
                s.indexOf("MSIE 8.") !== -1 ? a.browser = "ie8" : s.indexOf("MSIE 9.") !== -1 ? a.browser = "ie9" : s.indexOf("MSIE 10.") !== -1 ? a.browser = "ie10" : t.ActiveXObject || "ActiveXObject" in t ? a.browser = "ie11" : /android/gi.test(s) ? a.browser = "android" : /iphone|ipad|ipod/gi.test(s) ? a.browser = "ios" : /chrome/gi.test(s) ? a.browser = "chrome" : a.browser = "", typeof a.styleSupport("perspective") !== n && (e = a.styleSupport("transition"), a.transitionend = {
                    WebkitTransition: "webkitTransitionEnd",
                    transition: "transitionend"
                } [e], i = a.styleSupport("animation"), a.animationend = {
                ...
                } [i], a.transform = a.styleSupport("transform"), e && i && a.transform && (a.modernBrowser = !0))
            },
        ...
        }, o.private.browserInfo(), o.private.resize = new o.private.publicEvents("resize.cbp", 50, function() {
    ...
    function(e, t, i, n) {
        ...
        o.public = {
            ...
            destroy: function(t) {
                ...
                i.triggerEvent("beforeDestroy"), e.removeData(this, "cubeportfolio"), i.blocks.removeData("cbp"), i.$obj.removeClass("cbp-ready").removeAttr("style"), i.$ul.removeClass("cbp-wrapper"), o.private.resize.destroyEvent(i), i.$obj.off(".cbp"), i.blocks.removeClass("cbp-item-off").removeAttr("style"), i.blocks.find(".cbp-item-wrapper").each(function(t, i) {
                    var n = e(i),
                        o = n.children();
                    o.length ? o.unwrap() : n.remove()
                }), i.destroySlider && i.destroySlider(), i.$ul.unwrap(), i.addedWrapp && i.blocks.unwrap(), 0 === i.blocks.length && i.$ul.remove(), e.each(i.plugins, function(e, t) {
                    "function" == typeof t.destroy && t.destroy()
                }), e.isFunction(t) && t.call(i), i.triggerEvent("afterDestroy")
            },
            filter: function(t, i) {
                var a, s = o.private.checkInstance.call(this, "filter");
                if (!s.isAnimating) {
                    if (s.isAnimating = !0, e.isFunction(i) && s.registerEvent("filterFinish", i, !0), e.isFunction(t)) {
                        if ((a = t.call(s, s.blocks)) === n) throw new Error("When you call cubeportfolio API `filter` method with a param of type function you must return the blocks that will be visible.")
                    } else {
                        if (s.options.filterDeeplinking) {
                            var r = location.href.replace(/#cbpf=(.*?)([#\?&]|$)/gi, "");
                            location.href = r + "#cbpf=" + encodeURIComponent(t), s.singlePage && s.singlePage.url && (s.singlePage.url = location.href)
                        }
                        s.defaultFilter = t, a = s.filterConcat(s.defaultFilter)
                    }
                    s.triggerEvent("filterStart", a), s.singlePageInline && s.singlePageInline.isOpen ? s.singlePageInline.close("promise", {
                        callback: function() {
                            s.computeFilter(a)
                        }
                    }) : s.computeFilter(a)
            ...
            append: function(t, i) {
                ...
                return n.isAnimating || a.length < 1 ? void(e.isFunction(i) && i.call(n, a)) : (n.isAnimating = !0, void(n.singlePageInline && n.singlePageInline.isOpen ? n.singlePageInline.close("promise", {
                    callback: function() {
                        n.addItems(a, i, "append")
                    }
                }) : n.addItems(a, i, "append")))
            },
            ...
            layout: function(t) {
                ...
                return i.width = i.$obj.outerWidth(), i.isAnimating || i.width <= 0 ? void(e.isFunction(t) && t.call(i)) : ("alignCenter" === i.options.gridAdjustment && (i.wrapper[0].style.maxWidth = ""), i.storeData(i.blocks), i.layoutAndAdjustment(), void(e.isFunction(t) && t.call(i)))
            }
        }
    }(jQuery, window, document),
    function(e, t, i, n) {
        ...
        e.extend(o.prototype, {
            ...
            jumpDragToSlider: function(e) {
                var t, i, n, o = this,
                    a = e > 0;
                o.options.scrollByPage ? (t = o.cols * o.columnWidth, i = o.cols) : (t = o.columnWidth, i = 1), e = Math.abs(e), n = Math.floor(e / t) * i, e % t > 20 && (n += i), o.sliderActive = a ? Math.min(o.sliderActive + n, o.blocksOn.length - o.cols) : Math.max(0, o.sliderActive - n), o.goToSlider()
            },
            ...
            dragSlider: function() {
                function a(t) {
                    if (!m.sliderItemsLength()) {
                        if (y ? g = t : t.preventDefault(), m.options.auto && m.stopSliderAuto(), b) return void e(u).one("click.cbp", function() {
                            return !1
                        });
                        u = e(t.target), p = c(t).x, d = 0, h = -m.sliderActive * m.columnWidth, f = m.columnWidth * (m.blocksOn.length - m.cols), v.on(w.move, r), v.on(w.end, s), m.$obj.addClass("cbp-mode-slider-dragStart")
                    }
                }

                function s(e) {
                    m.$obj.removeClass("cbp-mode-slider-dragStart"), b = !0, 0 !== d ? (u.one("click.cbp", function(e) {
                        return !1
                    }), requestAnimationFrame(function() {
                        m.jumpDragToSlider(d), m.$ul.one(o.private.transitionend, l)
                    })) : l.call(m), v.off(w.move), v.off(w.end)
                }

                function r(e) {
                    d = p - c(e).x, (d > 8 || d < -8) && e.preventDefault(), m.isDrag = !0;
                    var t = h - d;
                    d < 0 && d < h ? t = (h - d) / 5 : d > 0 && h - d < -f && (t = (f + h - d) / 5 - f), o.private.modernBrowser ? m.$ul[0].style[o.private.transform] = "translate3d(" + t + "px, 0px, 0)" : m.$ul[0].style.left = t + "px"
                }
                ...
                var p, d, u, h, f, g, m = this,
                    v = e(i),
                    b = !1,
                    w = {},
                    y = !1;
                m.isDrag = !1, "ontouchstart" in t || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 ? (w = {
        ...
        o.prototype.filterLayout = function() {
            function t() {
                i.blocks.removeClass("cbp-item-on2off cbp-item-off2on cbp-item-on2on").each(function(t, i) {
                    var n = e(i).data("cbp");
                    n.left = n.leftNew, n.top = n.topNew, i.style.left = n.left + "px", i.style.top = n.top + "px", i.style[a.private.transform] = ""
            ...
            i.$obj.addClass("cbp-animation-" + i.options.animationType), i.blocksOn2On.addClass("cbp-item-on2on").each(function(t, i) {
                var n = e(i).data("cbp");
                i.style[a.private.transform] = "translate3d(" + (n.leftNew - n.left) + "px, " + (n.topNew - n.top) + "px, 0)"
            ...
            }), i.blocksOn2Off.length ? i.blocksOn2Off.last().data("cbp").wrapper.one(a.private.animationend, t) : i.blocksOff2On.length ? i.blocksOff2On.last().data("cbp").wrapper.one(a.private.animationend, t) : t(), i.resizeMainContainer()
        }, o.prototype.destroy = function() {
            var e = this.parent;
            e.$obj.removeClass("cbp-animation-" + e.options.animationType)
        }, a.plugins.animationClassic = function(t) {
            return !a.private.modernBrowser || e.inArray(t.options.animationType, ["boxShadow", "fadeOut", "flipBottom", "flipOut", "quicksand", "scaleSides", "skew"]) < 0 ? null : new o(t)
        }
    }(jQuery, window, document),
    function(e, t, i, n) {
        "use strict";
        ...
        o.prototype.filterLayout = function() {
            function t() {
                i.wrapper[0].removeChild(n), "sequentially" === i.options.animationType && i.blocksOn.each(function(t, i) {
                    e(i).data("cbp").wrapper[0].style[a.private.animationDelay] = ""
            ...
            n.setAttribute("class", "cbp-wrapper-helper"), i.wrapper[0].insertBefore(n, i.$ul[0]), requestAnimationFrame(function() {
                i.$obj.addClass("cbp-animation-" + i.options.animationType), i.blocksOff.addClass("cbp-item-off"), i.blocksOn.removeClass("cbp-item-off").each(function(t, n) {
                    var o = e(n).data("cbp");
                    o.left = o.leftNew, o.top = o.topNew, n.style.left = o.left + "px", n.style.top = o.top + "px", "sequentially" === i.options.animationType && (o.wrapper[0].style[a.private.animationDelay] = 60 * t + "ms")
                }), i.blocksOn.length ? i.blocksOn.last().data("cbp").wrapper.one(a.private.animationend, t) : i.blocksOnInitial.length ? i.blocksOnInitial.last().data("cbp").wrapper.one(a.private.animationend, t) : t(), i.resizeMainContainer()
            })
        }, o.prototype.destroy = function() {
            var e = this.parent;
            e.$obj.removeClass("cbp-animation-" + e.options.animationType)
        }, a.plugins.animationClone = function(t) {
            return !a.private.modernBrowser || e.inArray(t.options.animationType, ["fadeOutTop", "slideLeft", "sequentially"]) < 0 ? null : new o(t)
        }
    }(jQuery, window, document),
    function(e, t, i, n) {
        "use strict";
        ...
        o.prototype.filterLayout = function() {
            ...
            i.sortBlocks(o, "top"), o.children(".cbp-item-wrapper").each(function(e, t) {
                ...
                i.$obj.addClass("cbp-animation-" + i.options.animationType), i.blocksOff.addClass("cbp-item-off"), i.blocksOn.removeClass("cbp-item-off").each(function(t, i) {
                    var n = e(i).data("cbp");
                    n.left = n.leftNew, n.top = n.topNew, i.style.left = n.left + "px", i.style.top = n.top + "px", n.wrapper[0].style[a.private.animationDelay] = 50 * t + "ms"
                });
                var n = i.blocksOn.length,
                    s = o.length;
                0 === n && 0 === s ? t() : n < s ? o.last().children(".cbp-item-wrapper").one(a.private.animationend, t) : i.blocksOn.last().data("cbp").wrapper.one(a.private.animationend, t), i.resizeMainContainer()
            })
        }, o.prototype.destroy = function() {
            var e = this.parent;
            e.$obj.removeClass("cbp-animation-" + e.options.animationType)
        ...
        o.prototype.filterLayout = function() {
            ...
            n.setAttribute("class", "cbp-wrapper-helper"), i.wrapper[0].insertBefore(n, i.$ul[0]), requestAnimationFrame(function() {
                i.$obj.addClass("cbp-animation-" + i.options.animationType), i.blocksOff.addClass("cbp-item-off"), i.blocksOn.removeClass("cbp-item-off").each(function(t, i) {
                    var n = e(i).data("cbp");
                    n.left = n.leftNew, n.top = n.topNew, i.style.left = n.left + "px", i.style.top = n.top + "px"
                }), i.blocksOn.length ? i.$ul.one(a.private.animationend, t) : i.blocksOnInitial.length ? e(n).one(a.private.animationend, t) : t(), i.resizeMainContainer()
            })
        }, o.prototype.destroy = function() {
            var e = this.parent;
            e.$obj.removeClass("cbp-animation-" + e.options.animationType)
        }, a.plugins.animationWrapper = function(t) {
            return !a.private.modernBrowser || e.inArray(t.options.animationType, ["bounceBottom", "bounceLeft", "bounceTop", "moveLeft"]) < 0 ? null : new o(t)
        }
    }(jQuery, window, document),
    function(e, t, i, n) {
        "use strict";
        ...
        function o(e) {
            var t = this,
                i = e.options;
            t.parent = e, t.captionOn = i.caption, e.registerEvent("onMediaQueries", function(e) {
                e && e.hasOwnProperty("caption") ? t.captionOn !== e.caption && (t.destroy(), t.captionOn = e.caption, t.init()) : t.captionOn !== i.caption && (t.destroy(), t.captionOn = i.caption, t.init())
            }), t.init()
        }
        var a = e.fn.cubeportfolio.constructor;
                ...
                t.$obj.on("click.cbp", ".cbp-caption-defaultWrap", function(i) {
                    if (i.preventDefault(), !t.isAnimating) {
                        ...
                        if (t.$obj.addClass("cbp-caption-expand-active"), a.hasClass("cbp-caption-expand-open")) {
                            var l = r;
                            r = s, s = l, a.removeClass("cbp-caption-expand-open")
                        }
                        o.css(s), t.$obj.one("pluginResize.cbp", function() {
                            t.isAnimating = !1, t.$obj.removeClass("cbp-caption-expand-active"), 0 === s.height && (a.removeClass("cbp-caption-expand-open"), o.attr("style", ""))
                        }), t.layoutAndAdjustment(!0), o.css(r), requestAnimationFrame(function() {
                            a.addClass("cbp-caption-expand-open"), o.css(s), t.triggerEvent("gridAdjust"), t.triggerEvent("resizeGrid")
                        })
                    }
                })
            }, !0)
    ...
    function(e, t, i, n) {
        ...
        function o(t) {
            t.registerEvent("initEndWrite", function() {
                if (!(t.width <= 0)) {
                    var i = e.Deferred();
                    t.pushQueue("delayFrame", i), t.blocksOn.each(function(e, i) {
                        i.style[a.private.animationDelay] = e * t.options.displayTypeSpeed + "ms"
        ...
        a.plugins.displayBottomToTop = function(e) {
            return a.private.modernBrowser && "bottomToTop" === e.options.displayType && 0 !== e.blocksOn.length ? new o(e) : null
        }
    }(jQuery, window, document),
    function(e, t, i, n) {
        "use strict";
        ...
        function o(t) {
            t.registerEvent("initEndWrite", function() {
                if (!(t.width <= 0)) {
                    var i = e.Deferred();
                    t.pushQueue("delayFrame", i), t.obj.style[a.private.animationDuration] = t.options.displayTypeSpeed + "ms", t.$obj.addClass("cbp-displayType-fadeIn"), t.$obj.one(a.private.animationend, function() {
                        t.$obj.removeClass("cbp-displayType-fadeIn"), t.obj.style[a.private.animationDuration] = "", i.resolve()
                    })
                }
            }, !0)
        }
        ...
        a.plugins.displayFadeIn = function(e) {
            return !a.private.modernBrowser || "lazyLoading" !== e.options.displayType && "fadeIn" !== e.options.displayType || 0 === e.blocksOn.length ? null : new o(e)
        }
    }(jQuery, window, document),
    function(e, t, i, n) {
        "use strict";
        ...
        function o(t) {
            t.registerEvent("initEndWrite", function() {
                if (!(t.width <= 0)) {
                    var i = e.Deferred();
                    t.pushQueue("delayFrame", i), t.obj.style[a.private.animationDuration] = t.options.displayTypeSpeed + "ms", t.$obj.addClass("cbp-displayType-fadeInToTop"), t.$obj.one(a.private.animationend, function() {
                        t.$obj.removeClass("cbp-displayType-fadeInToTop"), t.obj.style[a.private.animationDuration] = "", i.resolve()
                    })
                }
            }, !0)
        }
        ...
        a.plugins.displayFadeInToTop = function(e) {
            return a.private.modernBrowser && "fadeInToTop" === e.options.displayType && 0 !== e.blocksOn.length ? new o(e) : null
        }
    }(jQuery, window, document),
    function(e, t, i, n) {
        "use strict";
        ...
        a.plugins.displaySequentially = function(e) {
            return a.private.modernBrowser && "sequentially" === e.options.displayType && 0 !== e.blocksOn.length ? new o(e) : null
        }
    }(jQuery, window, document),
    function(e, t, i, n) {
        "use strict";
            ...
            i.parent = t, i.filters = e(t.options.filters), i.filterData = [], t.registerEvent("afterPlugins", function(e) {
                ...
                i.filters.each(function(t, i) {
                    ...
                    e.each(n, function(e, t) {
                        ...
                        if (i.length) return i.addClass("cbp-filter-item-active").siblings().removeClass("cbp-filter-item-active"), n.splice(e, 1), !1
                    })
        ...
        o.prototype.registerFilter = function() {
            ...
            t.wrap = t.filters.find(".cbp-l-filters-dropdownWrap").on({
                ...
                s.hasClass("cbp-l-filters-dropdown") && (c.wrap = s.find(".cbp-l-filters-dropdownWrap"), c.header = s.find(".cbp-l-filters-dropdownHeader"), c.headerText = c.header.text()), i.$obj.cubeportfolio("showCounter", l), e.each(n, function(e, t) {
                    if (l.filter('[data-filter="' + t + '"]').length) return r = t, n.splice(e, 1), !1
                }), e.data(a, "filterName", r), t.filterData.push(a), t.filtersCallback(c, l.filter('[data-filter="' + r + '"]')), l.on("click.cbp", function() {
                    var n = e(this);
                    if (!n.hasClass("cbp-filter-item-active") && !i.isAnimating) {
                        t.filtersCallback(c, n), e.data(a, "filterName", n.data("filter"));
    ...
    function(e, t, i, n) {
        ...
        function o(t) {
            ...
            t.registerEvent("onMediaQueries", function(o) {
                t.options.gapVertical = o && o.hasOwnProperty("gapVertical") ? o.gapVertical : i, t.options.gapHorizontal = o && o.hasOwnProperty("gapHorizontal") ? o.gapHorizontal : n, t.blocks.each(function(i, n) {
                    var o = e(n).data("cbp");
                    o.widthAndGap = o.width + t.options.gapVertical, o.heightAndGap = o.height + t.options.gapHorizontal
                })
            })
        }
    ...
    function(e, t, i, n) {
        ...
        function o(t) {
            var i = this;
            i.parent = t, i.options = e.extend({}, a, i.parent.options.plugins.lazyLoad), t.registerEvent("initFinish", function() {
                i.loadImages(), t.registerEvent("resizeMainContainer", function() {
                    i.loadImages()
                }), t.registerEvent("filterFinish", function() {
                    i.loadImages()
                }), s.private.lazyLoadScroll.initEvent({
                    instance: i,
                    fn: i.loadImages
                })
            }, !0)
        ...
        var a = {
            ...
            r = e(t);
        s.private.lazyLoadScroll = new s.private.publicEvents("scroll.cbplazyLoad", 50), o.prototype.loadImages = function() {
            var t = this,
                i = t.parent.$obj.find("img").filter("[data-cbp-src]");
            0 !== i.length && (t.screenHeight = r.height(), i.each(function(i, n) {
                var o = e(n.parentNode);
                if (!t.isElementInScreen(n)) return void o.addClass(t.options.loadingClass);
                var a = n.getAttribute("data-cbp-src");
                null === t.parent.checkSrc(e("<img>").attr("src", a)) ? (t.removeLazyLoad(n, a), o.removeClass(t.options.loadingClass)) : (o.addClass(t.options.loadingClass), e("<img>").on("load.cbp error.cbp", function() {
                    t.removeLazyLoad(n, a, o)
                }).attr("src", a))
            }))
            ...
            s.private.lazyLoadScroll.destroyEvent(this)
    ...
    function(e, t, i, n) {
        ...
        function o(t) {
            var i = this;
            i.parent = t, i.options = e.extend({}, a, i.parent.options.plugins.loadMore), i.loadMore = e(i.options.element).find(".cbp-l-loadMore-link"), 0 !== i.loadMore.length && (i.loadItems = i.loadMore.find(".cbp-l-loadMore-loadItems"), "0" === i.loadItems.text() && i.loadMore.addClass("cbp-l-loadMore-stop"), t.registerEvent("filterStart", function(e) {
                i.populateItems().then(function() {
                    var t = i.items.filter(e).length;
                    t > 0 ? (i.loadMore.removeClass("cbp-l-loadMore-stop"), i.loadItems.html(t)) : i.loadMore.addClass("cbp-l-loadMore-stop")
                })
            }), i[i.options.action]())
        }
        var a = {
        ...
        o.prototype.populateItems = function() {
            ...
            var i = this,
                ...
                a = 0;
            return i.items.each(function(t, s) {
                return a !== i.options.loadItems && void(o && "*" !== o ? e(s).filter(o).length && (n.push(s), i.items[t] = null, a++) : (n.push(s), i.items[t] = null, a++))
            }), i.items = i.items.map(function(e, t) {
                return t
            }), 0 === n.length ? void i.loadMore.removeClass("cbp-l-loadMore-loading").addClass("cbp-l-loadMore-stop") : void i.parent.$obj.cubeportfolio("append", n, t)
        }, o.prototype.click = function() {
            function e() {
                t.loadMore.removeClass("cbp-l-loadMore-loading");
                var e, i = t.parent.defaultFilter;
                e = i && "*" !== i ? t.items.filter(i).length : t.items.length, 0 === e ? t.loadMore.addClass("cbp-l-loadMore-stop") : t.loadItems.html(e)
            }
            var t = this;
            t.loadMore.on("click.cbp", function(i) {
                i.preventDefault(), t.parent.isAnimating || t.loadMore.hasClass("cbp-l-loadMore-stop") || (t.loadMore.addClass("cbp-l-loadMore-loading"), t.populateItems().then(function() {
                    t.populateInsertItems(e)
                }))
            })
        }, o.prototype.auto = function() {
            function i() {
                if (!r && !o.loadMore.hasClass("cbp-l-loadMore-stop")) {
                    o.loadMore.offset().top - 200 > a.scrollTop() + a.height() || (r = !0, o.populateItems().then(function() {
            ...
            function n() {
                ...
                e = t && "*" !== t ? o.items.filter(t).length : o.items.length, 0 === e ? o.loadMore.removeClass("cbp-l-loadMore-loading").addClass("cbp-l-loadMore-stop") : (o.loadItems.html(e), a.trigger("scroll.loadMore")), r = !1, 0 === o.items.length && (s.private.loadMoreScroll.destroyEvent(o), o.parent.$obj.off("filterComplete.cbp"))
            }
            var o = this,
                a = e(t),
                r = !1;
            s.private.loadMoreScroll = new s.private.publicEvents("scroll.loadMore", 100), o.parent.$obj.one("initComplete.cbp", function() {
    ...
    function(e, t, i, n) {
        ...
        var a = e.fn.cubeportfolio.constructor,
            ...
            r = {
                init: function(t, n) {
                    var o, a = this;
                    if (a.cubeportfolio = t, a.type = n, a.isOpen = !1, a.options = a.cubeportfolio.options, "lightbox" === n && (a.cubeportfolio.registerEvent("resizeWindow", function() {
                        a.resizeImage()
                    }), a.localOptions = e.extend({}, s, a.cubeportfolio.options.plugins.lightbox)), "singlePageInline" === n) {
                        if (a.height = 0, a.createMarkupSinglePageInline(), a.cubeportfolio.registerEvent("resizeGrid", function() {
                            ...
                            var r = a.url.split("#cbpi="),
                                l = r.shift();
                            e.each(r, function(t, i) {
                                if (a.cubeportfolio.blocksOn.each(function(t, n) {
                                    var s = e(n).find(a.options.singlePageInlineDelegate + '[href="' + i + '"]');
                                    if (s.length) return o = s, !1
                                }), o) return !1
                            }), o && a.cubeportfolio.registerEvent("initFinish", function() {
                                a.openSinglePageInline(a.cubeportfolio.blocksOn, o[0])
                            }, !0)
                        }
                        return void(a.localOptions = e.extend({}, s, a.cubeportfolio.options.plugins.singlePageInline))
                    }
                    if (a.createMarkup(), "singlePage" === n) {
                        if (a.cubeportfolio.registerEvent("resizeWindow", function() {
                            ...
                            if (e.each(r, function(t, i) {
                                if (a.cubeportfolio.blocksOn.each(function(t, n) {
                                    var s = e(n).find(a.options.singlePageDelegate + '[href="' + i + '"]');
                                    if (s.length) return o = s, !1
                                }), o) return !1
                            }), o) {
                                a.url = l;
                                var c = o,
                                    p = c.attr("data-cbp-singlePage"),
                                    d = [];
                                p ? d = c.closest(e(".cbp-item")).find('[data-cbp-singlePage="' + p + '"]') : a.cubeportfolio.blocksOn.each(function(t, i) {
                                    var n = e(i);
                                    n.not(".cbp-item-off") && n.find(a.options.singlePageDelegate).each(function(t, i) {
                                        e(i).attr("data-cbp-singlePage") || d.push(i)
                                    })
                                }), a.openSinglePage(d, o[0])
                            } else if (r.length) {
                                var u = i.createElement("a");
                                u.setAttribute("href", r[0]), a.openSinglePage([u], u)
                            }
                        }
                        a.localOptions = e.extend({}, s, a.cubeportfolio.options.plugins.singlePage)
                    }
                },
                createMarkup: function() {
                    ...
                    "singlePage" === t.type && "left" !== t.options.singlePageAnimation && (o = " cbp-popup-singlePage-" + t.options.singlePageAnimation), t.wrap = e("<div/>", {
                        ...
                        "data-action": "lightbox" === t.type ? "close" : ""
                    }).appendTo(t.wrap)), "singlePage" === t.type && t.options.singlePageStickyNavigation === !1 ? t.navigationWrap = e("<div/>", {
                ...
                openLightbox: function(n, o) {
                    var a, s, r = this,
                        ...
                        p = [];
                    if (!r.isOpen) {
                        if (l = !0, r.isOpen = !0, r.stopEvents = !1, r.dataArray = [], r.current = null, null === (a = o.getAttribute("href"))) throw new Error("HEI! Your clicked element doesn't have a href attribute.");
                        e.each(n, function(t, i) {
                            ...
                            if (e.inArray(o, p) === -1) {
                                ...
                                if (/youtu\.?be/i.test(o)) {
                                    var d = o.lastIndexOf("v=") + 2;
                                    1 === d && (d = o.lastIndexOf("/") + 1), n = o.substring(d), /autoplay=/i.test(n) || (n += "&autoplay=1"), n = n.replace(/\?|&/, "?"), s = "//www.youtube.com/embed/" + n, l = "isYoutube"
                                } else /vimeo\.com/i.test(o) ? (n = o.substring(o.lastIndexOf("/") + 1), /autoplay=/i.test(n) || (n += "&autoplay=1"), n = n.replace(/\?|&/, "?"), s = "//player.vimeo.com/video/" + n, l = "isVimeo") : /www\.ted\.com/i.test(o) ? (s = "http://embed.ted.com/talks/" + o.substring(o.lastIndexOf("/") + 1) + ".html", l = "isTed") : /soundcloud\.com/i.test(o) ? (s = o, l = "isSoundCloud") : /(\.mp4)|(\.ogg)|(\.ogv)|(\.webm)/i.test(o) ? (s = o.indexOf("|") !== -1 ? o.split("|") : o.split("%7C"), l = "isSelfHostedVideo") : /\.mp3$/i.test(o) && (s = o, l = "isSelfHostedAudio");
                                r.dataArray.push({
                                    src: s,
                            ...
                            p.push(o)
                        }), r.counterTotal = r.dataArray.length, 1 === r.counterTotal ? (r.nextButton.hide(), r.prevButton.hide(), r.dataActionImg = "") : (r.nextButton.show(), r.prevButton.show(), r.dataActionImg = 'data-action="next"'), r.wrap.appendTo(i.body), r.scrollTop = e(t).scrollTop(), r.originalStyle = e("html").attr("style"), e("html").css({
                            overflow: "hidden",
                ...
                openSinglePage: function(n, o) {
                    var s, r = this,
                        ...
                        c = [];
                    if (!r.isOpen) {
                        if (r.cubeportfolio.singlePageInline && r.cubeportfolio.singlePageInline.isOpen && r.cubeportfolio.singlePageInline.close(), r.isOpen = !0, r.stopEvents = !1, r.dataArray = [], r.current = null, null === (s = o.getAttribute("href"))) throw new Error("HEI! Your clicked element doesn't have a href attribute.");
                        if (e.each(n, function(t, i) {
                            var n = i.getAttribute("href");
                            e.inArray(n, c) === -1 && (s === n && (r.current = l), r.dataArray.push({
                                url: n,
                                element: i
                            }), l++), c.push(n)
                        }), r.counterTotal = r.dataArray.length, 1 === r.counterTotal ? (r.nextButton.hide(), r.prevButton.hide()) : (r.nextButton.show(), r.prevButton.show()), r.wrap.appendTo(i.body), r.scrollTop = e(t).scrollTop(), r.contentWrap.scrollTop(0), r.wrap.show(), r.finishOpen = 2, r.navigationMobile = e(), r.wrap.one(a.private.transitionend, function() {
                            e("html").css({
                                overflow: "hidden",
                                marginRight: t.innerWidth - e(i).width()
                            }), r.wrap.addClass("cbp-popup-transitionend"), r.options.singlePageStickyNavigation && (r.wrap.addClass("cbp-popup-singlePage-sticky"), r.navigationWrap.width(r.contentWrap[0].clientWidth)), --r.finishOpen <= 0 && r.updateSinglePageIsOpen.call(r)
                        }), "ie8" !== a.private.browser && "ie9" !== a.private.browser || (e("html").css({
                            overflow: "hidden",
                            marginRight: t.innerWidth - e(i).width()
                        }), r.wrap.addClass("cbp-popup-transitionend"), r.options.singlePageStickyNavigation && (r.navigationWrap.width(r.contentWrap[0].clientWidth), setTimeout(function() {
                            ...
                            var p = r.contentWrap[0];
                            p.addEventListener("touchstart", function() {
                                var e = p.scrollTop,
                                    t = p.scrollHeight,
                                    i = e + p.offsetHeight;
                                0 === e ? p.scrollTop = 1 : i === t && (p.scrollTop = e - 1)
                            })
                        }
                    }
                },
                openSinglePageInline: function(i, n, o) {
                    var a, s, r, l = this;
                    if (o = o || !1, l.fromOpen = o, l.storeBlocks = i, l.storeCurrentBlock = n, l.isOpen) return s = l.cubeportfolio.blocksOn.index(e(n).closest(".cbp-item")), void(l.dataArray[l.current].url !== n.getAttribute("href") || l.current !== s ? l.cubeportfolio.singlePageInline.close("open", {
                        blocks: i,
                        currentBlock: n,
                        fromOpen: !0
                    }) : l.close());
                    if (l.isOpen = !0, l.stopEvents = !1, l.dataArray = [], l.current = null, null === (a = n.getAttribute("href"))) throw new Error("HEI! Your clicked element doesn't have a href attribute.");
                    if (r = e(n).closest(".cbp-item")[0], i.each(function(e, t) {
                        r === t && (l.current = e)
                    }), l.dataArray[l.current] = {
                        url: a,
                        element: n
                    }, e(l.dataArray[l.current].element).parents(".cbp-item").addClass("cbp-singlePageInline-active"), l.counterTotal = i.length, l.wrap.insertBefore(l.cubeportfolio.wrapper), l.topDifference = 0, "top" === l.options.singlePageInlinePosition) l.blocksToMove = i, l.top = 0;
                        ...
                        var c = e(i[l.current]),
                            p = c.data("cbp").top,
                            d = p + c.height();
                        l.top = p, l.blocksToMove = e(), i.each(function(t, i) {
                            var n = e(i),
                                o = n.data("cbp").top,
                                a = o + n.height();
                            a <= p || (o >= p && (l.blocksToMove = l.blocksToMove.add(i)), o < p && a > p && (l.top = a + l.options.gapHorizontal, a - p > l.topDifference && (l.topDifference = a - p + l.options.gapHorizontal)))
                        }), l.top = Math.max(l.top - l.options.gapHorizontal, 0)
                    } else {
                        var c = e(i[l.current]),
                            p = c.data("cbp").top,
                            d = p + c.height();
                        l.top = d, l.blocksToMove = e(), i.each(function(t, i) {
                            var n = e(i),
                                o = n.height(),
                                a = n.data("cbp").top,
                                s = a + o;
                            if (!(s <= d)) return a >= d - o / 2 ? void(l.blocksToMove = l.blocksToMove.add(i)) : void(s > d && a < d && (s > l.top && (l.top = s), s - d > l.topDifference && (l.topDifference = s - d)))
                        })
                    }
                ...
                resizeSinglePageInline: function() {
                    ...
                    e.height = 0 === e.top || e.top === e.cubeportfolio.height ? e.wrap.outerHeight(!0) : e.wrap.outerHeight(!0) - e.options.gapHorizontal, e.height += e.topDifference, e.storeBlocks.each(function(e, t) {
                        ...
                        a.private.modernBrowser ? i.style[a.private.transform] = "translate3d(0px, " + e.height + "px, 0)" : i.style.marginTop = e.height + "px"
                    ...
                    var t = this,
                        ...
                        o = function(a) {
                            ...
                            s.type = "text/javascript", s.readyState ? s.onreadystatechange = function() {
                                ...
                                n++, e[n] && o(e[n])
                            }, r ? s.src = r : s.text = a.text, t.content[0].appendChild(s)
                        };
                    o(e[0])
                },
                updateSinglePage: function(t, i, n) {
                    var o, a = this;
                    a.content.addClass("cbp-popup-content").removeClass("cbp-popup-content-basic"), n === !1 && a.content.removeClass("cbp-popup-content").addClass("cbp-popup-content-basic"), a.counter && (o = e(a.getCounterMarkup(a.options.singlePageCounter, a.current + 1, a.counterTotal)), a.counter.text(o.text())), a.fromAJAX = {
                        html: t,
                        scripts: i
                ...
                updateSinglePageIsOpen: function() {
                    var e, t = this;
                    t.wrap.addClass("cbp-popup-ready"), t.wrap.removeClass("cbp-popup-loading"), t.content.html(t.fromAJAX.html), t.fromAJAX.scripts && t.appendScriptsToWrap(t.fromAJAX.scripts), t.fromAJAX = {}, t.cubeportfolio.$obj.trigger("updateSinglePageStart.cbp"), e = t.content.find(".cbp-slider"), e.length ? (e.find(".cbp-slider-item").addClass("cbp-item"), t.slider = e.cubeportfolio({
                        layoutMode: "slider",
                        mediaQueries: [{
                            width: 1,
                            cols: 1
                ...
                createPinterestShare: function(e) {
                    if (e.length && !e.attr("onclick")) {
                        ...
                        n && (i = n.src), e.attr("onclick", "window.open('http://pinterest.com/pin/create/button/?url=" + encodeURIComponent(t.location.href) + "&media=" + i + "', '_blank', 'top=100,left=100,toolbar=0,status=0,width=620,height=400'); return false;")
                    }
                },
                updateSinglePageInline: function(e, t) {
                    var i = this;
                    i.content.html(e), t && i.appendScriptsToWrap(t), i.cubeportfolio.$obj.trigger("updateSinglePageInlineStart.cbp"), 0 !== i.localOptions.delay ? setTimeout(function() {
                ...
                updateSelfHostedVideo: function(e, t, i) {
                    ...
                    for (n = 0; n < e.length; n++) /(\.mp4)/i.test(e[n]) ? a += '<source src="' + e[n] + '" type="video/mp4">' : /(\.ogg)|(\.ogv)/i.test(e[n]) ? a += '<source src="' + e[n] + '" type="video/ogg">' : /(\.webm)/i.test(e[n]) && (a += '<source src="' + e[n] + '" type="video/webm">');
                    a += 'Your browser does not support the video tag.</video><div class="cbp-popup-lightbox-bottom">' + (t ? '<div class="cbp-popup-lightbox-title">' + t + "</div>" : "") + i + "</div></div>", o.content.html(a), o.wrap.addClass("cbp-popup-ready"), o.preloadNearbyImages()
                },
                ...
                singlePageJumpTo: function(t) {
                    var i = this;
                    i.current = i.getIndex(i.current + t), e.isFunction(i.options.singlePageCallback) && (i.resetWrap(), i.contentWrap.scrollTop(0), i.wrap.addClass("cbp-popup-loading"), i.slider && a.private.resize.destroyEvent(e.data(i.slider[0], "cubeportfolio")), i.options.singlePageCallback.call(i, i.dataArray[i.current].url, i.dataArray[i.current].element), i.options.singlePageDeeplinking && (location.href = i.url + "#cbp=" + i.dataArray[i.current].url))
                },
                resetWrap: function() {
                    var e = this;
                ...
                getIndex: function(e) {
                    var t = this;
                    return e %= t.counterTotal, e < 0 && (e = t.counterTotal + e), e
                },
                close: function(i, n) {
                    function o() {
                        r.slider && a.private.resize.destroyEvent(e.data(r.slider[0], "cubeportfolio")), r.content.html(""), r.wrap.detach(), r.cubeportfolio.$obj.removeClass("cbp-popup-singlePageInline-open cbp-popup-singlePageInline-close"), "promise" === i && e.isFunction(n.callback) && n.callback.call(r.cubeportfolio)
                    }

                    function s() {
                        var n = e(t).scrollTop();
                        r.resetWrap(), e(t).scrollTop(n), r.options.singlePageInlineInFocus && "promise" !== i ? e("html,body").animate({
                    ...
                    r.isOpen = !1, "singlePageInline" === r.type ? "open" === i ? (r.wrap.removeClass("cbp-popup-singlePageInline-ready"), e(r.dataArray[r.current].element).closest(".cbp-item").removeClass("cbp-singlePageInline-active"), r.openSinglePageInline(n.blocks, n.currentBlock, n.fromOpen)) : (r.height = 0, r.revertResizeSinglePageInline(), r.wrap.removeClass("cbp-popup-singlePageInline-ready"), r.cubeportfolio.$obj.addClass("cbp-popup-singlePageInline-close"), r.cubeportfolio.$obj.find(".cbp-item").removeClass("cbp-singlePageInline-active"), a.private.modernBrowser ? r.wrap.one(a.private.transitionend, function() {
                        s()
                    }) : s()) : "singlePage" === r.type ? (r.resetWrap(), e(t).scrollTop(r.scrollTop), r.stopScroll = !0, r.wrap.removeClass("cbp-popup-ready cbp-popup-transitionend cbp-popup-singlePage-open cbp-popup-singlePage-sticky"), e("html").css({
                        overflow: "",
                        marginRight: "",
                        position: ""
                    }), "ie8" !== a.private.browser && "ie9" !== a.private.browser || (r.slider && a.private.resize.destroyEvent(e.data(r.slider[0], "cubeportfolio")), r.content.html(""), r.wrap.detach()), r.wrap.one(a.private.transitionend, function() {
                        r.slider && a.private.resize.destroyEvent(e.data(r.slider[0], "cubeportfolio")), r.content.html(""), r.wrap.detach()
                    })) : (l = !1, r.originalStyle ? e("html").attr("style", r.originalStyle) : e("html").css({
                        overflow: "",
                        marginRight: ""
                    }), e(t).scrollTop(r.scrollTop), r.slider && a.private.resize.destroyEvent(e.data(r.slider[0], "cubeportfolio")), r.content.html(""), r.wrap.detach())
                },
                ...
                preloadNearbyImages: function() {
                    for (var e = this, t = [e.getIndex(e.current + 1), e.getIndex(e.current + 2), e.getIndex(e.current + 3), e.getIndex(e.current - 1), e.getIndex(e.current - 2), e.getIndex(e.current - 3)], i = t.length - 1; i >= 0; i--) "isImage" === e.dataArray[t[i]].type && e.cubeportfolio.checkSrc(e.dataArray[t[i]])
                }
            },
            l = !1,
            c = !1,
        ...
        o.prototype.run = function() {
            var t = this,
                n = t.parent,
                o = e(i.body);
            n.lightbox = null, n.options.lightboxDelegate && !c && (c = !0, n.lightbox = Object.create(r), n.lightbox.init(n, "lightbox"), o.on("click.cbp", n.options.lightboxDelegate, function(i) {
                i.preventDefault();
                var o = e(this),
                ...
                r ? r.blocksOn.each(function(t, i) {
                    ...
                    o.not(".cbp-item-off") && o.find(n.options.lightboxDelegate).each(function(t, i) {
                        a ? e(i).attr("data-cbp-lightbox") === a && l.push(i) : l.push(i)
                    })
                }) : l = a ? s.find(n.options.lightboxDelegate + "[data-cbp-lightbox=" + a + "]") : s.find(n.options.lightboxDelegate), n.lightbox.openLightbox(l, o[0])
            })), n.singlePage = null, n.options.singlePageDelegate && !p && (p = !0, n.singlePage = Object.create(r), n.singlePage.init(n, "singlePage"), o.on("click.cbp", n.options.singlePageDelegate, function(i) {
                i.preventDefault();
                var o = e(this),
                ...
                r ? r.blocksOn.each(function(t, i) {
                    ...
                    o.not(".cbp-item-off") && o.find(n.options.singlePageDelegate).each(function(t, i) {
                        a ? e(i).attr("data-cbp-singlePage") === a && l.push(i) : l.push(i)
                    })
                }) : l = a ? s.find(n.options.singlePageDelegate + "[data-cbp-singlePage=" + a + "]") : s.find(n.options.singlePageDelegate), n.singlePage.openSinglePage(l, o[0])
            })), n.singlePageInline = null, n.options.singlePageInlineDelegate && (n.singlePageInline = Object.create(r), n.singlePageInline.init(n, "singlePageInline"), n.$obj.on("click.cbp", n.options.singlePageInlineDelegate, function(t) {
                t.preventDefault();
            ...
            var n, o, a;
            return n = t.closest(".cbp-popup-singlePageInline"), n.length ? (a = t.closest(".cbp", n[0]), a.length ? a : n) : (o = t.closest(".cbp-popup-singlePage"), o.length ? (a = t.closest(".cbp", o[0]), a.length ? a : o) : (a = t.closest(".cbp"), a.length ? a : e(i.body)))
        }, o.prototype.destroy = function() {
            var t = this.parent;
            e(i.body).off("click.cbp"), c = !1, p = !1, t.lightbox && t.lightbox.destroy(), t.singlePage && t.singlePage.destroy(), t.singlePageInline && t.singlePageInline.destroy()
        ...
        o.prototype.runEvent = function(t) {
            ...
            o.value === n || i.parent.isAnimating || (o.value = n, n.length > 0 ? t.attr("value", n) : t.removeAttr("value"), i.parent.$obj.cubeportfolio("filter", function(t) {
                var s = t.filter(function(t, i) {
                    if (e(i).find(o.el).text().search(a) > -1) return !0
                });
    ...
    function(e, t, i, n) {
        ...
        function o(t) {
            var i = this;
            i.parent = t, i.options = e.extend({}, a, i.parent.options.plugins.slider);
    ...
    function(e) {
        ...
        e.infinitescroll = function(t, i, n) {
            ...
            _create: function(i, n) {
                ...
                o.path = o.path || this._determinepath(s), o.contentSelector = o.contentSelector || this.element, o.loading.selector = o.loading.selector || o.contentSelector, o.loading.msg = o.loading.msg || e('<div id="infscr-loading"><img alt="Loading..." src="' + o.loading.img + '" /><div>' + o.loading.msgText + "</div></div>"), (new Image).src = o.loading.img, o.pixelsFromNavToBottom === t && (o.pixelsFromNavToBottom = e(document).height() - e(o.navSelector).offset().top, this._debug("pixelsFromNavToBottom: " + o.pixelsFromNavToBottom));
                var r = this;
                ...
                }, o.callback = function(i, s, r) {
                    o.behavior && i["_callback_" + o.behavior] !== t && i["_callback_" + o.behavior].call(e(o.contentSelector)[0], s, r), n && n.call(e(o.contentSelector)[0], s, o, r), o.prefill && a.bind("resize.infinite-scroll", i._prefill)
            ...
            _error: function(e) {
                var i = this.options;
                if (i.behavior && this["_error_" + i.behavior] !== t) return void this["_error_" + i.behavior].call(this, e);
                "destroy" !== e && "end" !== e && (e = "unknown"), this._debug("Error", e), ("end" === e || i.state.isBeyondMaxPage) && this._showdonemsg(), i.state.isDone = !0, i.state.currPage = 1, i.state.isPaused = !1, i.state.isBeyondMaxPage = !1, this._binding("unbind")
            },
            _loadcallback: function(i, n, o) {
                var a, s = this.options,
                    r = this.options.callback,
                    l = s.state.isDone ? "done" : s.appendCallback ? "append" : "no-append";
                if (s.behavior && this["_loadcallback_" + s.behavior] !== t) return void this["_loadcallback_" + s.behavior].call(this, i, n);
                switch (l) {
                    case "done":
                        return this._showdonemsg(), !1;
                    case "no-append":
                        if ("html" === s.dataType && (n = "<div>" + n + "</div>", n = e(n).find(s.itemSelector)), 0 === n.length) return this._error("end");
                        break;
                    case "append":
                        var c = i.children();
                        if (0 === c.length) return this._error("end");
                        for (a = document.createDocumentFragment(); i[0].firstChild;) a.appendChild(i[0].firstChild);
                        this._debug("contentSelector", e(s.contentSelector)[0]), e(s.contentSelector)[0].appendChild(a), n = c.get()
                }
                if (s.loading.finished.call(e(s.contentSelector)[0], s), s.animate) {
                    var p = e(window).scrollTop() + e(s.loading.msg).height() + s.extraScrollPx + "px";
                    e("html,body").animate({
                        scrollTop: p
                    }, 800, function() {
                ...
                s.animate || (s.state.isDuringAjax = !1), r(this, n, o), s.prefill && this._prefill()
            },
            ...
            _showdonemsg: function() {
                var i = this.options;
                if (i.behavior && this["_showdonemsg_" + i.behavior] !== t) return void this["_showdonemsg_" + i.behavior].call(this);
            ...
            beginAjax: function(i) {
                ...
                switch (n = e(e(i.contentSelector).is("table, tbody") ? "<tbody/>" : "<div/>"), o = "function" == typeof l ? l(i.state.currPage) : l.join(i.state.currPage), r._debug("heading into ajax", o), a = "html" === i.dataType || "json" === i.dataType ? i.dataType : "html+callback", i.appendCallback && "html" === i.dataType && (a += "+callback"), a) {
                    case "html+callback":
                    ...
                    case "html":
                        r._debug("Using " + a.toUpperCase() + " via $.ajax() method"), e.ajax({
                            ...
                            complete: function(e, t) {
                                s = void 0 !== e.isResolved ? e.isResolved() : "success" === t || "notmodified" === t, s ? r._loadcallback(n, e.responseText, o) : r._error("end")
                            }
                        });
                        break;
                    case "json":
                        r._debug("Using " + a.toUpperCase() + " via $.ajax() method"), e.ajax({
                            ...
                            success: function(e, a, l) {
                                if (s = void 0 !== l.isResolved ? l.isResolved() : "success" === a || "notmodified" === a, i.appendCallback)
                                    if (i.template !== t) {
                                        var c = i.template(e);
                                        n.append(c), s ? r._loadcallback(n, c) : r._error("end")
                                    } else r._debug("template must be defined."), r._error("end");
                                else s ? r._loadcallback(n, e, o) : r._error("end")
                            },
                            error: function() {
            ...
            scroll: function() {
                var e = this.options,
                    i = e.state;
                if (e.behavior && this["scroll_" + e.behavior] !== t) return void this["scroll_" + e.behavior].call(this);
                i.isDuringAjax || i.isInvalidPage || i.isDone || i.isDestroyed || i.isPaused || this._nearbottom() && this.retrieve()
            },
            toggle: function() {
                this._pausing()
            },
    ...
    function(e) {
        ...
        function t() {
            ...
            return n.height || !(t = l.compatMode) && e.support.boxModel || (i = "CSS1Compat" === t ? p : l.body, n = {
        ...
        function i() {
            return {
                top: c.pageYOffset || p.scrollTop || l.body.scrollTop,
                left: c.pageXOffset || p.scrollLeft || l.body.scrollLeft
            }
        }
        ...
        function n() {
            if (r.length) {
                ...
                for (o = o || t(), a = a || i(); n < r.length; n++)
                    if (e.contains(p, s[n][0])) {
                        var l = e(s[n]),
                            c = {
                            ...
                            d = l.offset(),
                            u = l.data("inview"),
                            h = l.data("inview-offset") ? l.data("inview-offset") : 0;
                        if (!a || !o) return;
                        d.top + c.height > a.top - h && d.top + h < a.top + o.height && d.left + c.width > a.left && d.left < a.left + o.width ? u || l.data("inview", !0).trigger("inview", [!0]) : u && l.data("inview", !1).trigger("inview", [!1])
                    }
            }
        }
        var o, a, s, r = [],
        ...
        e.event.special.inview = {
            add: function(t) {
                r.push({
                    ...
                    $element: e(this),
                    element: this
                }), !s && r.length && (s = setInterval(n, 250))
            },
            remove: function(e) {
    ...
    function(e, t) {
        ...
        function i() {
            return d.style[u.transform] = "", d.style[u.transform] = "rotateY(90deg)", "" !== d.style[u.transform]
        }
        ...
        function a(t) {
            ...
            return e.each(t, function(t) {
                t = e.camelCase(t), t = e.transit.propertyMap[t] || e.cssProps[t] || t, t = l(t), u[t] && (t = l(u[t])), e.inArray(t, i) === -1 && i.push(t)
            }), i
        }
        ...
        function r(t, i) {
            i || (e.cssNumber[t] = !0), e.transit.propertyMap[t] = u.transform, e.cssHooks[t] = {
                get: function(i) {
        ...
        u.transition = t("transition"), u.transitionDelay = t("transitionDelay"), u.transform = t("transform"), u.transformOrigin = t("transformOrigin"), u.filter = t("Filter"), u.transform3d = i();
        var f = {
                transition: "transitionend",
            ...
            g = u.transitionEnd = f[u.transition] || null;
        for (var m in u) u.hasOwnProperty(m) && void 0 === e.support[m] && (e.support[m] = u[m]);
        return d = null, e.cssEase = {
            ...
            set: function(t, i) {
                var o = i;
                o instanceof n || (o = new n(o)), "WebkitTransform" !== u.transform || h ? t.style[u.transform] = o.toString() : t.style[u.transform] = o.toString(!0), e(t).data("transform", o)
            }
            ...
            var r = this,
                ...
                c = !0,
                d = e.extend(!0, {}, t);
            "function" == typeof i && (a = i, i = void 0), "object" == typeof i && (n = i.easing, l = i.delay || 0, c = void 0 === i.queue || i.queue, a = i.complete, i = i.duration), "function" == typeof n && (a = n, n = void 0), void 0 !== d.easing && (n = d.easing, delete d.easing), void 0 !== d.duration && (i = d.duration, delete d.duration), void 0 !== d.complete && (a = d.complete, delete d.complete), void 0 !== d.queue && (c = d.queue, delete d.queue), void 0 !== d.delay && (l = d.delay, delete d.delay), void 0 === i && (i = e.fx.speeds._default), void 0 === n && (n = e.cssEase._default), i = p(i);
            var h = s(d, i, n, l),
                f = e.transit.enabled && u.transition,
                m = f ? parseInt(i, 10) + parseInt(l, 10) : 0;
            if (0 === m) {
                return o(r, c, function(e) {
                    r.css(d), a && a.apply(r), e && e()
                }), r
            }
            var v = {},
                b = function(t) {
                    ...
                    m > 0 && g && e.transit.useTransitionEnd ? (i = !0, r.bind(g, n)) : window.setTimeout(n, m), r.each(function() {
                        m > 0 && (this.style[u.transition] = h), e(this).css(d)
                    })
                };
            return o(r, c, function(e) {
    ...
    function(e, t, i, n) {
        ...
        var o = null,
            ...
            d = function(e) {
                if (0 !== e.length) {
                    ...
                    if ("number" === i || "string" === i) {
                        s.indexOf(t) > -1 ? n.list = t : n.resource = t
                    } else "object" === i && (n = t);
                    return n
                }
            },
            u = function() {
                ...
                return t.queue = new i, t.url = a, t.get = function() {
                    return o ? (e.ajax({
                        type: "GET",
                        url: this.url,
        ...
        e.jribbble.shots = function(t, i) {
                ...
                a = function(t) {
                    return function(i, n) {
                        ...
                        return this.queue.add(function(i) {
                            ...
                            i.url += "/" + t + "/", o.resource && (i.url += o.resource, delete o.resource), i.url += p(e.extend(o, a))
                        }), this
                    }
                },
                s = function() {
                    return e.extend(this, u()), this.url += "/shots/", this.queue.add(function(t) {
                        n.resource && (t.shotId = n.resource, t.url += n.resource, delete n.resource), t.url += p(e.extend(n, o))
                    }), setTimeout(function() {
                        this.queue.flush(this).get()
                    }.bind(this)), this
                };
            return s.prototype.attachments = a("attachments"), s.prototype.buckets = a("buckets"), s.prototype.likes = a("likes"), s.prototype.projects = a("projects"), s.prototype.rebounds = a("rebounds"), s.prototype.comments = function(t, i) {
                var n = d([].slice.call(arguments)) || {},
                    o = i || {};
                return this.queue.add(function(t) {
                    if (!t.shotId) throw new Error(r.shotId("comments"));
                    t.url += "/comments/", n.resource && (t.commentId = n.resource, t.url += n.resource + "/", delete n.resource), t.url += p(e.extend(n, o))
            ...
            var t = "users",
                i = l(e, t),
                n = h.call(this, t);
            return n.prototype = c.call(this, ["buckets", "followers", "following", "likes", "projects", "shots", "teams"]), n.prototype.isFollowing = function(e) {
                return this.queue.add(function(t) {
                    t.url += "/following/" + e
                }), this
            }, new n(i)
    ...
    function(e) {
        ...
        var t = {
            ...
            init: function(t) {
                return this.each(function() {
                    e(this).unbind("click.lightcase").bind("click.lightcase", function(i) {
                        i.preventDefault(), e(this).lightcase("start", t)
                    })
                })
            },
            start: function(i) {
                t.origin = lightcase.origin = this, t.settings = lightcase.settings = e.extend(!0, {
                    idPrefix: "lightcase-",
                    ...
                    errorMessage: function() {
                        return '<p class="' + t.settings.classPrefix + 'error">' + t.settings.labels.errorMessage + "</p>"
                    },
                    labels: {
                    ...
                    onClose: {},
                    onCleanup: {}
                }, i, t.origin.data ? t.origin.data("lc-options") : {}), t._callHooks(t.settings.onInit), t.objectData = t._setObjectData(this), t._cacheScrollPosition(), t._watchScrollInteraction(), t._addElements(), t._open(), t.dimensions = t.getViewportDimensions()
            },
            get: function(e) {
                return t.objects[e]
            },
            ...
            _setObjectData: function(i) {
                var n = e(i),
                    o = {
                        title: t.settings.title || n.attr(t._prefixAttributeName("title")) || n.attr("title"),
                        caption: t.settings.caption || n.attr(t._prefixAttributeName("caption")) || n.children("img").attr("alt"),
                        url: t._determineUrl(),
                        requestType: t.settings.ajax.type,
                        requestData: t.settings.ajax.data,
                        requestDataType: t.settings.ajax.dataType,
                        rel: n.attr(t._determineAttributeSelector()),
                        type: t.settings.type || t._verifyDataType(t._determineUrl()),
                        isPartOfSequence: t._isPartOfSequence(n.attr(t.settings.attr), ":"),
                        isPartOfSequenceWithSlideshow: t._isPartOfSequence(n.attr(t.settings.attr), ":slideshow"),
                        currentIndex: e(t._determineAttributeSelector()).index(n),
                        sequenceLength: e(t._determineAttributeSelector()).length
                    };
                return o.sequenceInfo = o.currentIndex + 1 + t.settings.labels["sequenceInfo.of"] + o.sequenceLength, o.prevIndex = o.currentIndex - 1, o.nextIndex = o.currentIndex + 1, o
            },
            _prefixAttributeName: function(e) {
                return "data-" + t.settings.attrPrefix + e
            },
            _determineLinkTarget: function() {
                return t.settings.href || e(t.origin).attr(t._prefixAttributeName("href")) || e(t.origin).attr("href")
            },
            _determineAttributeSelector: function() {
                var i = e(t.origin),
                    n = "";
                if (void 0 !== t.cache.selector) n = t.cache.selector;
                else if (t.settings.useCategories === !0 && i.attr(t._prefixAttributeName("categories"))) {
                    var o = i.attr(t._prefixAttributeName("categories")).split(" ");
                    e.each(o, function(e, i) {
                        e > 0 && (n += ","), n += "[" + t._prefixAttributeName("categories") + '~="' + i + '"]'
                    })
                } else n = "[" + t.settings.attr + '="' + i.attr(t.settings.attr) + '"]';
                return t.cache.selector = n, n
            },
            _determineUrl: function() {
                var i, n = t._verifyDataUrl(t._determineLinkTarget()),
                    o = 0,
                    a = 0;
                return e.each(n, function(e, n) {
                    t._devicePixelRatio() >= n.density && n.density >= a && t._matchMedia()("screen and (min-width:" + n.width + "px)").matches && n.width >= o && (o = n.width, a = n.density, i = n.url)
                }), i
            },
            _normalizeUrl: function(e) {
                ...
                return e.split(",").map(function(e) {
                    ...
                    return e.trim().split(/\s+/).forEach(function(e, n) {
                        if (0 === n) return i.url = e;
                        var o = e.substring(0, e.length - 1),
                            a = e[e.length - 1],
                            s = parseInt(o, 10),
                            r = parseFloat(o);
                        "w" === a && t.test(o) ? i.width = s : "h" === a && t.test(o) ? i.height = s : "x" !== a || isNaN(r) || (i.density = r)
                    }), i
                })
            },
            _isPartOfSequence: function(i, n) {
                var o = e("[" + t.settings.attr + '="' + i + '"]');
                return new RegExp(n).test(i) && o.length > 1
            },
            isSlideshowEnabled: function() {
                return t.objectData.isPartOfSequence && (t.settings.slideshow === !0 || t.objectData.isPartOfSequenceWithSlideshow === !0)
            },
            _loadContent: function() {
                t.cache.originalObject && t._restoreObject(), t._createObject()
            },
            _createObject: function() {
                var i;
                switch (t.objectData.type) {
                    case "image":
                        i = e(new Image), i.attr({
                            src: t.objectData.url,
                            alt: t.objectData.title
                        });
                        break;
                    case "inline":
                        i = e('<div class="' + t.settings.classPrefix + 'inlineWrap"></div>'), i.html(t._cloneObject(e(t.objectData.url))), e.each(t.settings.inline, function(e, n) {
                            i.attr(t._prefixAttributeName(e), n)
                        });
                        break;
                    case "ajax":
                        i = e('<div class="' + t.settings.classPrefix + 'inlineWrap"></div>'), e.each(t.settings.ajax, function(e, n) {
                            "data" !== e && i.attr(t._prefixAttributeName(e), n)
                        });
                        break;
                    case "flash":
                        i = e('<embed src="' + t.objectData.url + '" type="application/x-shockwave-flash"></embed>'), e.each(t.settings.flash, function(e, t) {
                            i.attr(e, t)
                        });
                        break;
                    case "video":
                        i = e("<video></video>"), i.attr("src", t.objectData.url), e.each(t.settings.video, function(e, t) {
                            i.attr(e, t)
                        });
                        break;
                    default:
                        i = e("<iframe></iframe>"), i.attr({
                            src: t.objectData.url
                        }), e.each(t.settings.iframe, function(e, t) {
                            i.attr(e, t)
                        })
                }
                t._addObject(i), t._loadObject(i)
            },
            _addObject: function(e) {
                t.objects.contentInner.html(e), t._loading("start"), t._callHooks(t.settings.onStart), t.settings.showSequenceInfo === !0 && t.objectData.isPartOfSequence ? (t.objects.sequenceInfo.html(t.objectData.sequenceInfo), t.objects.sequenceInfo.show()) : (t.objects.sequenceInfo.empty(), t.objects.sequenceInfo.hide()), t.settings.showTitle === !0 && void 0 !== t.objectData.title && "" !== t.objectData.title ? (t.objects.title.html(t.objectData.title), t.objects.title.show()) : (t.objects.title.empty(), t.objects.title.hide()), t.settings.showCaption === !0 && void 0 !== t.objectData.caption && "" !== t.objectData.caption ? (t.objects.caption.html(t.objectData.caption), t.objects.caption.show()) : (t.objects.caption.empty(), t.objects.caption.hide())
            },
            _loadObject: function(i) {
                switch (t.objectData.type) {
                    case "inline":
                        e(t.objectData.url) ? t._showContent(i) : t.error();
                        break;
                    case "ajax":
                        e.ajax(e.extend({}, t.settings.ajax, {
                            url: t.objectData.url,
                            type: t.objectData.requestType,
                            dataType: t.objectData.requestDataType,
                            data: t.objectData.requestData,
                            success: function(e, n, o) {
                                "json" === t.objectData.requestDataType ? t.objectData.data = e : i.html(e), t._showContent(i)
                            },
                    ...
                    case "flash":
                        ...
                        break;
                    case "video":
                        "function" == typeof i.get(0).canPlayType || 0 === t.objects.case.find("video").length ? t._showContent(i) : t.error();
                        break;
                    default:
                        t.objectData.url ? (i.on("load", function() {
                            t._showContent(i)
                        }), i.on("error", function() {
                            t.error()
                        })) : t.error()
            ...
            error: function() {
                t.objectData.type = "error";
                var i = e('<div class="' + t.settings.classPrefix + 'inlineWrap"></div>');
                i.html(t.settings.errorMessage), t.objects.contentInner.html(i), t._showContent(t.objects.contentInner)
            },
            _calculateDimensions: function(e) {
                t._cleanupDimensions();
                var i = {
                    objectWidth: e.attr("width") ? e.attr("width") : e.attr(t._prefixAttributeName("width")),
                    objectHeight: e.attr("height") ? e.attr("height") : e.attr(t._prefixAttributeName("height"))
                };
                if (!t.settings.disableShrink) switch (i.maxWidth = parseInt(t.dimensions.windowWidth * t.settings.shrinkFactor), i.maxHeight = parseInt(t.dimensions.windowHeight * t.settings.shrinkFactor), i.maxWidth > t.settings.maxWidth && (i.maxWidth = t.settings.maxWidth), i.maxHeight > t.settings.maxHeight && (i.maxHeight = t.settings.maxHeight), i.differenceWidthAsPercent = parseInt(100 / i.maxWidth * i.objectWidth), i.differenceHeightAsPercent = parseInt(100 / i.maxHeight * i.objectHeight), t.objectData.type) {
                    case "image":
                    case "flash":
                    case "video":
                    ...
                    case "error":
                        ...
                        break;
                    default:
                        (isNaN(i.objectWidth) || i.objectWidth > i.maxWidth) && !t.settings.forceWidth && (i.objectWidth = i.maxWidth), (isNaN(i.objectHeight) && "auto" !== i.objectHeight || i.objectHeight > i.maxHeight) && !t.settings.forceHeight && (i.objectHeight = i.maxHeight)
                }
                t.settings.forceWidth ? i.maxWidth = i.objectWidth : e.attr(t._prefixAttributeName("max-width")) && (i.maxWidth = e.attr(t._prefixAttributeName("max-width"))), t.settings.forceHeight ? i.maxHeight = i.objectHeight : e.attr(t._prefixAttributeName("max-height")) && (i.maxHeight = e.attr(t._prefixAttributeName("max-height"))), t._adjustDimensions(e, i)
            },
            _adjustDimensions: function(e, i) {
                e.css({
                    width: i.objectWidth,
                    height: i.objectHeight,
                    "max-width": i.maxWidth,
                    "max-height": i.maxHeight
                }), t.objects.contentInner.css({
                    width: e.outerWidth(),
                    height: e.outerHeight(),
                    "max-width": "100%"
                }), t.objects.case.css({
                    width: t.objects.contentInner.outerWidth()
                }), t.objects.case.css({
                    "margin-top": parseInt(-(t.objects.case.outerHeight() / 2)),
                    "margin-left": parseInt(-(t.objects.case.outerWidth() / 2))
                })
            },
            _loading: function(e) {
                "start" === e ? (t.objects.case.addClass(t.settings.classPrefix + "loading"), t.objects.loading.show()) : "end" === e && (t.objects.case.removeClass(t.settings.classPrefix + "loading"), t.objects.loading.hide())
            },
            ...
            _verifyDataUrl: function(e) {
                return !(!e || void 0 === e || "" === e) && (e.indexOf("#") > -1 && (e = e.split("#"), e = "#" + e[e.length - 1]), t._normalizeUrl(e.toString()))
            },
            _verifyDataType: function(e) {
                var i = t.settings.typeMapping;
                if (!e) return !1;
                for (var n in i)
                    if (i.hasOwnProperty(n))
                        for (var o = i[n].split(","), a = 0; a < o.length; a++) {
                            var s = o[a].toLowerCase(),
                                r = new RegExp(".(" + s + ")$", "i"),
                                l = e.toLowerCase().split("?")[0].substr(-5);
                            if (r.test(l) === !0 || "inline" === n && e.indexOf(s) > -1) return n
                        }
                return "iframe"
            },
            _addElements: function() {
                void 0 !== t.objects.case && e("#" + t.objects.case.attr("id")).length || t.settings.markup()
            },
            _showContent: function(e) {
                switch (t.objects.case.attr(t._prefixAttributeName("type"), t.objectData.type), t.cache.object = e, t._calculateDimensions(e), t._callHooks(t.settings.onFinish), t.settings.transitionIn) {
                    case "scrollTop":
                    case "scrollRight":
                    case "scrollBottom":
                    case "scrollLeft":
                    ...
                    case "scrollVertical":
                        t.transition.scroll(t.objects.case, "in", t.settings.speedIn), t.transition.fade(t.objects.contentInner, "in", t.settings.speedIn);
                        break;
                    case "elastic":
                        t.objects.case.css("opacity") < 1 && (t.transition.zoom(t.objects.case, "in", t.settings.speedIn), t.transition.fade(t.objects.contentInner, "in", t.settings.speedIn));
                    case "fade":
                    case "fadeInline":
                        t.transition.fade(t.objects.case, "in", t.settings.speedIn), t.transition.fade(t.objects.contentInner, "in", t.settings.speedIn);
                        break;
                    default:
                        t.transition.fade(t.objects.case, "in", 0)
                }
                t._loading("end"), t.isBusy = !1
            },
            _processContent: function() {
                switch (t.isBusy = !0, t.settings.transitionOut) {
                    case "scrollTop":
                    case "scrollRight":
                    case "scrollBottom":
                    case "scrollLeft":
                    case "scrollVertical":
                    case "scrollHorizontal":
                        t.objects.case.is(":hidden") ? (t.transition.fade(t.objects.case, "out", 0, 0, function() {
                            t._loadContent()
                        }), t.transition.fade(t.objects.contentInner, "out", 0)) : t.transition.scroll(t.objects.case, "out", t.settings.speedOut, function() {
                            t._loadContent()
                        });
                        break;
                    case "fade":
                        t.objects.case.is(":hidden") ? t.transition.fade(t.objects.case, "out", 0, 0, function() {
                            t._loadContent()
                        }) : t.transition.fade(t.objects.case, "out", t.settings.speedOut, 0, function() {
                            t._loadContent()
                        });
                        break;
                    case "fadeInline":
                    case "elastic":
                        t.objects.case.is(":hidden") ? t.transition.fade(t.objects.case, "out", 0, 0, function() {
                            t._loadContent()
                        }) : t.transition.fade(t.objects.contentInner, "out", t.settings.speedOut, 0, function() {
                            t._loadContent()
                        });
                        break;
                    default:
                        t.transition.fade(t.objects.case, "out", 0, 0, function() {
                            t._loadContent()
                        })
                }
            },
            _handleEvents: function() {
                t._unbindEvents(), t.objects.nav.children().not(t.objects.close).hide(), t.isSlideshowEnabled() && (t.settings.slideshowAutoStart !== !0 && !t.isSlideshowStarted || t.objects.nav.hasClass(t.settings.classPrefix + "paused") ? t._stopTimeout() : t._startTimeout()), t.settings.liveResize && t._watchResizeInteraction(), t.objects.close.click(function(e) {
                    e.preventDefault(), t.close()
                }), t.settings.closeOnOverlayClick === !0 && t.objects.overlay.css("cursor", "pointer").click(function(e) {
                    e.preventDefault(), t.close()
                }), t.settings.useKeys === !0 && t._addKeyEvents(), t.objectData.isPartOfSequence && (t.objects.nav.attr(t._prefixAttributeName("ispartofsequence"), !0), t.objects.nav.data("items", t._setNavigation()), t.objects.prev.click(function(e) {
                    e.preventDefault(), t.settings.navigateEndless !== !0 && t.item.isFirst() || (t.objects.prev.unbind("click"), t.cache.action = "prev", t.objects.nav.data("items").prev.click(), t.isSlideshowEnabled() && t._stopTimeout())
                }), t.objects.next.click(function(e) {
                    e.preventDefault(), t.settings.navigateEndless !== !0 && t.item.isLast() || (t.objects.next.unbind("click"), t.cache.action = "next", t.objects.nav.data("items").next.click(), t.isSlideshowEnabled() && t._stopTimeout())
                }), t.isSlideshowEnabled() && (t.objects.play.click(function(e) {
                    e.preventDefault(), t._startTimeout()
                }), t.objects.pause.click(function(e) {
                    e.preventDefault(), t._stopTimeout()
                })), t.settings.swipe === !0 && (e.isPlainObject(e.event.special.swipeleft) && t.objects.case.on("swipeleft", function(e) {
                    e.preventDefault(), t.objects.next.click(), t.isSlideshowEnabled() && t._stopTimeout()
                }), e.isPlainObject(e.event.special.swiperight) && t.objects.case.on("swiperight", function(e) {
                    e.preventDefault(), t.objects.prev.click(), t.isSlideshowEnabled() && t._stopTimeout()
                })))
            },
            _addKeyEvents: function() {
                e(document).bind("keyup.lightcase", function(e) {
                    if (!t.isBusy) switch (e.keyCode) {
                        case 27:
                            t.objects.close.click();
                            break;
                        case 37:
                            t.objectData.isPartOfSequence && t.objects.prev.click();
                            break;
                        case 39:
                            t.objectData.isPartOfSequence && t.objects.next.click()
                    }
                })
            },
            _startTimeout: function() {
                t.isSlideshowStarted = !0, t.objects.play.hide(), t.objects.pause.show(), t.cache.action = "next", t.objects.nav.removeClass(t.settings.classPrefix + "paused"), t.timeout = setTimeout(function() {
                    t.objects.nav.data("items").next.click()
                }, t.settings.timeout)
            },
            _stopTimeout: function() {
                t.objects.play.show(), t.objects.pause.hide(), t.objects.nav.addClass(t.settings.classPrefix + "paused"), clearTimeout(t.timeout)
            },
            _setNavigation: function() {
                var i = e(t.cache.selector || t.settings.attr),
                    n = t.objectData.sequenceLength - 1,
                    o = {
                        prev: i.eq(t.objectData.prevIndex),
                        next: i.eq(t.objectData.nextIndex)
                    };
                return t.objectData.currentIndex > 0 ? t.objects.prev.show() : o.prevItem = i.eq(n), t.objectData.nextIndex <= n ? t.objects.next.show() : o.next = i.eq(0), t.settings.navigateEndless === !0 && (t.objects.prev.show(), t.objects.next.show()), o
            },
            item: {
                isFirst: function() {
                    return 0 === t.objectData.currentIndex
                },
                isLast: function() {
                    return t.objectData.currentIndex === t.objectData.sequenceLength - 1
                }
            },
            _cloneObject: function(e) {
                var i = e.clone(),
                    n = e.attr("id");
                return e.is(":hidden") ? (t._cacheObjectData(e), e.attr("id", t.settings.idPrefix + "temp-" + n).empty()) : i.removeAttr("id"), i.show()
            },
            isMobileDevice: function() {
                return !!navigator.userAgent.toLowerCase().match(t.settings.mobileMatchExpression)
            },
            isTransitionSupported: function() {
                ...
                for (var a in o) o.hasOwnProperty(a) && a in i.style && (t.support.transition = o[a], n = !0);
                return n
            },
            transition: {
                fade: function(e, i, n, o, a) {
                    var s = "in" === i,
                        r = {},
                        l = e.css("opacity"),
                        c = {},
                        p = o ? o : s ? 1 : 0;
                    !t.isOpen && s || (r.opacity = l, c.opacity = p, e.css(r).show(), t.support.transitions ? (c[t.support.transition + "transition"] = n + "ms ease", setTimeout(function() {
                        e.css(c), setTimeout(function() {
                            e.css(t.support.transition + "transition", ""), !a || !t.isOpen && s || a()
                        }, n)
                    }, 15)) : (e.stop(), e.animate(c, n, a)))
                },
                scroll: function(e, i, n, o) {
                    var a = "in" === i,
                        s = a ? t.settings.transitionIn : t.settings.transitionOut,
                        r = "left",
                        l = {},
                        c = a ? 0 : 1,
                        p = a ? "-50%" : "50%",
                    ...
                    if (t.isOpen || !a) {
                        switch (s) {
                            case "scrollTop":
                                ...
                                break;
                            case "scrollRight":
                                p = a ? "150%" : "50%", h = a ? "50%" : "150%";
                                break;
                            case "scrollBottom":
                                r = "top", p = a ? "150%" : "50%", h = a ? "50%" : "150%";
                                break;
                            case "scrollHorizontal":
                                p = a ? "150%" : "50%", h = a ? "50%" : "-50%";
                                break;
                            case "scrollVertical":
                                r = "top", p = a ? "-50%" : "50%", h = a ? "50%" : "150%"
                        }
                        if ("prev" === t.cache.action) switch (s) {
                            case "scrollHorizontal":
                                p = a ? "-50%" : "50%", h = a ? "50%" : "150%";
                                break;
                            case "scrollVertical":
                                p = a ? "150%" : "50%", h = a ? "50%" : "-50%"
                        }
                        l.opacity = c, l[r] = p, d.opacity = u, d[r] = h, e.css(l).show(), t.support.transitions ? (d[t.support.transition + "transition"] = n + "ms ease", setTimeout(function() {
                            e.css(d), setTimeout(function() {
                                e.css(t.support.transition + "transition", ""), !o || !t.isOpen && a || o()
                            }, n)
                        }, 15)) : (e.stop(), e.animate(d, n, o))
                    }
                },
                zoom: function(e, i, n, o) {
                    var a = "in" === i,
                        s = {},
                        r = e.css("opacity"),
                        ...
                        c = {},
                        p = a ? 1 : 0,
                        d = a ? "scale(1)" : "scale(0.75)";
                    !t.isOpen && a || (s.opacity = r, s[t.support.transition + "transform"] = l, c.opacity = p, e.css(s).show(), t.support.transitions ? (c[t.support.transition + "transform"] = d, c[t.support.transition + "transition"] = n + "ms ease", setTimeout(function() {
                        e.css(c), setTimeout(function() {
                            e.css(t.support.transition + "transform", ""), e.css(t.support.transition + "transition", ""), !o || !t.isOpen && a || o()
                        }, n)
                    }, 15)) : (e.stop(), e.animate(c, n, o)))
                }
            },
            _callHooks: function(i) {
                "object" == typeof i && e.each(i, function(e, i) {
                    "function" == typeof i && i.call(t.origin)
                })
            },
            _cacheObjectData: function(i) {
                e.data(i, "cache", {
                    id: i.attr("id"),
                    content: i.html()
                }), t.cache.originalObject = i
            },
            _restoreObject: function() {
                var i = e('[id^="' + t.settings.idPrefix + 'temp-"]');
                i.attr("id", e.data(t.cache.originalObject, "cache").id), i.html(e.data(t.cache.originalObject, "cache").content)
            },
            resize: function() {
                t.isOpen && (t.isSlideshowEnabled() && t._stopTimeout(), t.dimensions = t.getViewportDimensions(), t._calculateDimensions(t.cache.object))
            },
            _cacheScrollPosition: function() {
                ...
                t.cache.scrollPosition = t.cache.scrollPosition || {}, t._assertContentInvisible() ? t.cache.cacheScrollPositionSkipped ? (delete t.cache.cacheScrollPositionSkipped, t._restoreScrollPosition()) : (n.width() > i.width() && (t.cache.scrollPosition.left = o.left), n.height() > i.height() && (t.cache.scrollPosition.top = o.top)) : t.cache.cacheScrollPositionSkipped = !0
            },
            _watchResizeInteraction: function() {
                e(window).resize(t.resize)
            },
            _unwatchResizeInteraction: function() {
                e(window).off("resize", t.resize)
            },
            _watchScrollInteraction: function() {
                e(window).scroll(t._cacheScrollPosition), e(window).resize(t._cacheScrollPosition)
            },
            _unwatchScrollInteraction: function() {
                e(window).off("scroll", t._cacheScrollPosition), e(window).off("resize", t._cacheScrollPosition)
            },
            _assertContentInvisible: function() {
                return e(e("body").children().not("[id*=" + t.settings.idPrefix + "]").get(0)).height() > 0
            },
            _restoreScrollPosition: function() {
                e(window).scrollTop(parseInt(t.cache.scrollPosition.top)).scrollLeft(parseInt(t.cache.scrollPosition.left)).resize()
            },
            _switchToFullScreenMode: function() {
                t.settings.shrinkFactor = 1, t.settings.overlayOpacity = 1, e("html").addClass(t.settings.classPrefix + "fullScreenMode")
            },
            _open: function() {
                switch (t.isOpen = !0, t.support.transitions = !!t.settings.cssTransitions && t.isTransitionSupported(), t.support.mobileDevice = t.isMobileDevice(), t.support.mobileDevice && (e("html").addClass(t.settings.classPrefix + "isMobileDevice"), t.settings.fullScreenModeForMobile && t._switchToFullScreenMode()), t.settings.transitionIn || (t.settings.transitionIn = t.settings.transition), t.settings.transitionOut || (t.settings.transitionOut = t.settings.transition), t.settings.transitionIn) {
                    case "fade":
                    case "fadeInline":
                    case "elastic":
                    case "scrollTop":
                    ...
                    case "scrollVertical":
                    case "scrollHorizontal":
                        t.objects.case.is(":hidden") && (t.objects.close.css("opacity", 0), t.objects.overlay.css("opacity", 0), t.objects.case.css("opacity", 0), t.objects.contentInner.css("opacity", 0)), t.transition.fade(t.objects.overlay, "in", t.settings.speedIn, t.settings.overlayOpacity, function() {
                            t.transition.fade(t.objects.close, "in", t.settings.speedIn), t._handleEvents(), t._processContent()
                        });
                        break;
                    default:
                        t.transition.fade(t.objects.overlay, "in", 0, t.settings.overlayOpacity, function() {
                            t.transition.fade(t.objects.close, "in", 0), t._handleEvents(), t._processContent()
                        })
                }
                e("html").addClass(t.settings.classPrefix + "open"), t.objects.case.attr("aria-hidden", "false")
            },
            close: function() {
                switch (t.isOpen = !1, t.isSlideshowEnabled() && (t._stopTimeout(), t.isSlideshowStarted = !1, t.objects.nav.removeClass(t.settings.classPrefix + "paused")), t.objects.loading.hide(), t._unbindEvents(), t._unwatchResizeInteraction(), t._unwatchScrollInteraction(), e("html").removeClass(t.settings.classPrefix + "open"), t.objects.case.attr("aria-hidden", "true"), t.objects.nav.children().hide(), t._restoreScrollPosition(), t._callHooks(t.settings.onClose), t.settings.transitionOut) {
                    case "fade":
                    case "fadeInline":
                    case "scrollTop":
                    case "scrollRight":
                    ...
                    case "scrollVertical":
                        t.transition.fade(t.objects.case, "out", t.settings.speedOut, 0, function() {
                            t.transition.fade(t.objects.overlay, "out", t.settings.speedOut, 0, function() {
                                t.cleanup()
                            })
                        });
                        break;
                    case "elastic":
                        t.transition.zoom(t.objects.case, "out", t.settings.speedOut, function() {
                            t.transition.fade(t.objects.overlay, "out", t.settings.speedOut, 0, function() {
                                t.cleanup()
                            })
                        });
            ...
            _unbindEvents: function() {
                t.objects.overlay.unbind("click"), e(document).unbind("keyup.lightcase"), t.objects.case.unbind("swipeleft").unbind("swiperight"), t.objects.prev.unbind("click"), t.objects.next.unbind("click"), t.objects.play.unbind("click"), t.objects.pause.unbind("click"), t.objects.close.unbind("click")
            },
            _cleanupDimensions: function() {
                var e = t.objects.contentInner.css("opacity");
                t.objects.case.css({
                    width: "",
                    height: "",
                    top: "",
                    ...
                    "margin-top": "",
                    "margin-left": ""
                }), t.objects.contentInner.removeAttr("style").css("opacity", e), t.objects.contentInner.children().removeAttr("style")
            },
            cleanup: function() {
                t._cleanupDimensions(), t.objects.loading.hide(), t.objects.overlay.hide(), t.objects.case.hide(), t.objects.prev.hide(), t.objects.next.hide(), t.objects.play.hide(), t.objects.pause.hide(), t.objects.case.removeAttr(t._prefixAttributeName("type")), t.objects.nav.removeAttr(t._prefixAttributeName("ispartofsequence")), t.objects.contentInner.empty().hide(), t.objects.info.children().empty(), t.cache.originalObject && t._restoreObject(), t._callHooks(t.settings.onCleanup), t.cache = {}
            },
            ...
            _isPublicMethod: function(e) {
                return "function" == typeof t[e] && "_" !== e.charAt(0)
            },
            _export: function() {
                window.lightcase = {}, e.each(t, function(e) {
                    t._isPublicMethod(e) && (lightcase[e] = t[e])
                })
            }
        };
        t._export(), e.fn.lightcase = function(i) {
            return t._isPublicMethod(i) ? t[i].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof i && i ? void e.error("Method " + i + " does not exist on jQuery.lightcase") : t.init.apply(this, arguments)
        }
    }(jQuery),
    function(e) {
        "use strict";
        var t = {
            init: function(t) {
                ...
                return this.each(function() {
                    var t = {
                        init: function() {
                            var i = e(this);
                            t.prepareRanfolio.apply(i), t.buildRanfolio.apply(i), "" != n.delimiter && t.addDelimiter.apply(i), t.changeLinkColor.apply(i)
                        },
                        prepareRanfolio: function() {
                            var t = e(this);
                            t.addClass("vlt-ranfolio"), t.wrapInner('<div class="vlt-ranfolio-inner">'), t.find("a").addClass("vlt-ranfolio-link"), t.append('<div class="vlt-ranfolio-image"><img src="" alt=""></div>'), 1 == n.showCounter && t.addClass("vlt-ranfolio-counter")
                        },
                        changeLinkColor: function() {
                            e(this).find("a.vlt-ranfolio-link").each(function() {
                                var t = e(this).data("color");
                                t && e(this).on({
                                    mouseenter: function() {
                                        t && e(this).attr("style", "color: " + t + ";")
                                    },
                                    mouseleave: function() {
                                        e(this).attr("style", "")
                                    }
                        ...
                        buildRanfolio: function() {
                            var t = e(this),
                                o = t.find("a.vlt-ranfolio-link"),
                                a = t.find(".vlt-ranfolio-image img");
                            o.on("mouseenter", function() {
                                t.addClass("hovered");
                                var o = e(this).data("image"),
                                    s = t.width(),
                                    r = t.height();
                                if (o != i) {
                                    if (a.attr("src", o), i = o, 1 == n.randomWidth) {
                                        var l = Math.floor(Math.random() * (n.randomInterval[1] - n.randomInterval[0] + 1)) + n.randomInterval[0];
                                        a.css("max-width", l + "%")
                                    }
                                    a.on("load", function() {
                                        if (1 == n.randomPosition) {
                                            var e = a.width(),
                                                t = a.height(),
                                                i = (Math.random() * (s - e)).toFixed(),
                                                o = (Math.random() * (r - t)).toFixed();
                                            a.css({
                                                position: "absolute",
                                                top: o + "px",
                                                left: i + "px"
                                ...
                                t.removeClass("hovered"), a.stop().animate({
                                    opacity: 0
                                }, 0)
                            })
                        },
                        addDelimiter: function() {
                            var t = e(this),
                                i = t.find(".vlt-ranfolio-link:not(:last-of-type)");
                            e('<span class="vlt-ranfolio-delimiter">' + n.delimiter + "</span>").insertAfter(i)
                        }
                    };
                    t.init.apply(this)
                })
            ...
            destroy: function() {
                this.removeClass("vlt-ranfolio vlt-ranfolio-counter hovered"), this.find("a").removeClass("vlt-ranfolio-link").attr("style", ""), this.find(".vlt-ranfolio-image").remove(), this.find(".vlt-ranfolio-delimiter").remove()
            }
        };
        e.fn.ranfolio = function(i) {
            return t[i] ? t[i].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof i && i ? void e.error("Method: " + i + " does not exists. jQuery.ranfolio") : t.init.apply(this, arguments)
        }
    }(jQuery),
    function() {
        "use strict";
        var e, t = function(n, o) {
            ...
            function s() {
                ...
                t.attr("data-swiper-autoplay") && (e = t.attr("data-swiper-autoplay") || _.params.autoplay), _.autoplayTimeoutId = setTimeout(function() {
                    _.params.loop ? (_.fixLoop(), _._slideNext(), _.emit("onAutoplay", _)) : _.isEnd ? o.autoplayStopOnLast ? _.stopAutoplay() : (_._slideTo(0), _.emit("onAutoplay", _)) : (_._slideNext(), _.emit("onAutoplay", _))
                }, e)
            }
            ...
            function c(e) {
                ...
                if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                    if (37 === t || 39 === t || 38 === t || 40 === t) {
                        ...
                        for (var r = [
                            [s.left, s.top],
                            [s.left + _.width, s.top],
                            [s.left, s.top + _.height],
                            [s.left + _.width, s.top + _.height]
                        ], l = 0; l < r.length; l++) {
                            var c = r[l];
                            c[0] >= n.left && c[0] <= n.left + o && c[1] >= n.top && c[1] <= n.top + a && (i = !0)
                        }
                        if (!i) return
                    }
            ...
            function d(e) {
                ...
                if (0 !== t) {
                    if (_.params.mousewheelInvert && (t = -t), _.params.freeMode) {
                        var o = _.getWrapperTranslate() + t * _.params.mousewheelSensitivity,
                            a = _.isBeginning,
                            s = _.isEnd;
                        if (o >= _.minTranslate() && (o = _.minTranslate()), o <= _.maxTranslate() && (o = _.maxTranslate()), _.setWrapperTransition(0), _.setWrapperTranslate(o), _.updateProgress(), _.updateActiveIndex(), (!a && _.isBeginning || !s && _.isEnd) && _.updateClasses(), _.params.freeModeSticky ? (clearTimeout(_.mousewheel.timeout), _.mousewheel.timeout = setTimeout(function() {
                            _.slideReset()
                        }, 300)) : _.params.lazyLoading && _.lazy && _.lazy.load(), _.emit("onScroll", _, e), _.params.autoplay && _.params.autoplayDisableOnInteraction && _.stopAutoplay(), 0 === o || o === _.maxTranslate()) return
                    } else {
            ...
            function u(t, i) {
                t = e(t);
                var n, o, a, s = _.rtl ? -1 : 1;
                n = t.attr("data-swiper-parallax") || "0", o = t.attr("data-swiper-parallax-x"), a = t.attr("data-swiper-parallax-y"), o || a ? (o = o || "0", a = a || "0") : _.isHorizontal() ? (o = n, a = "0") : (a = n, o = "0"), o = o.indexOf("%") >= 0 ? parseInt(o, 10) * i * s + "%" : o * i * s + "px", a = a.indexOf("%") >= 0 ? parseInt(a, 10) * i + "%" : a * i + "px", t.transform("translate3d(" + o + ", " + a + ",0px)")
            }
            ...
            var m = {};
            for (var v in o)
                if ("object" != typeof o[v] || null === o[v] || o[v].nodeType || o[v] === window || o[v] === document || void 0 !== i && o[v] instanceof i || "undefined" != typeof jQuery && o[v] instanceof jQuery) m[v] = o[v];
                else {
                    m[v] = {};
                    for (var b in o[v]) m[v][b] = o[v][b]
                } for (var w in f)
                if (void 0 === o[w]) o[w] = f[w];
                else if ("object" == typeof o[w])
                    for (var y in f[w]) void 0 === o[w][y] && (o[w][y] = f[w][y]);
            var _ = this;
            if (_.params = o, _.originalParams = m, _.classNames = [], void 0 !== e && void 0 !== i && (e = i), (void 0 !== e || (e = void 0 === i ? window.Dom7 || window.Zepto || window.jQuery : i)) && (_.$ = e, _.currentBreakpoint = void 0, _.getActiveBreakpoint = function() {
            ...
            }, _.params.breakpoints && _.setBreakpoint(), _.container = e(n), 0 !== _.container.length)) {
                ...
                _.container[0].swiper = _, _.container.data("swiper", _), _.classNames.push(_.params.containerModifierClass + _.params.direction), _.params.freeMode && _.classNames.push(_.params.containerModifierClass + "free-mode"), _.support.flexbox || (_.classNames.push(_.params.containerModifierClass + "no-flexbox"), _.params.slidesPerColumn = 1), _.params.autoHeight && _.classNames.push(_.params.containerModifierClass + "autoheight"), (_.params.parallax || _.params.watchSlidesVisibility) && (_.params.watchSlidesProgress = !0), _.params.touchReleaseOnEdges && (_.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(_.params.effect) >= 0 && (_.support.transforms3d ? (_.params.watchSlidesProgress = !0, _.classNames.push(_.params.containerModifierClass + "3d")) : _.params.effect = "slide"), "slide" !== _.params.effect && _.classNames.push(_.params.containerModifierClass + _.params.effect), "cube" === _.params.effect && (_.params.resistanceRatio = 0, _.params.slidesPerView = 1, _.params.slidesPerColumn = 1, _.params.slidesPerGroup = 1, _.params.centeredSlides = !1, _.params.spaceBetween = 0, _.params.virtualTranslate = !0), "fade" !== _.params.effect && "flip" !== _.params.effect || (_.params.slidesPerView = 1, _.params.slidesPerColumn = 1, _.params.slidesPerGroup = 1, _.params.watchSlidesProgress = !0, _.params.spaceBetween = 0, void 0 === g && (_.params.virtualTranslate = !0)), _.params.grabCursor && _.support.touch && (_.params.grabCursor = !1), _.wrapper = _.container.children("." + _.params.wrapperClass), _.params.pagination && (_.paginationContainer = e(_.params.pagination), _.params.uniqueNavElements && "string" == typeof _.params.pagination && _.paginationContainer.length > 1 && 1 === _.container.find(_.params.pagination).length && (_.paginationContainer = _.container.find(_.params.pagination)), "bullets" === _.params.paginationType && _.params.paginationClickable ? _.paginationContainer.addClass(_.params.paginationModifierClass + "clickable") : _.params.paginationClickable = !1, _.paginationContainer.addClass(_.params.paginationModifierClass + _.params.paginationType)), (_.params.nextButton || _.params.prevButton) && (_.params.nextButton && (_.nextButton = e(_.params.nextButton), _.params.uniqueNavElements && "string" == typeof _.params.nextButton && _.nextButton.length > 1 && 1 === _.container.find(_.params.nextButton).length && (_.nextButton = _.container.find(_.params.nextButton))), _.params.prevButton && (_.prevButton = e(_.params.prevButton), _.params.uniqueNavElements && "string" == typeof _.params.prevButton && _.prevButton.length > 1 && 1 === _.container.find(_.params.prevButton).length && (_.prevButton = _.container.find(_.params.prevButton)))), _.isHorizontal = function() {
                    ...
                    _.params.allowSwipeToNext = !1, _.params.allowSwipeToPrev === !1 && _.params.grabCursor && _.unsetGrabCursor()
                }, _.lockSwipeToPrev = function() {
                    _.params.allowSwipeToPrev = !1, _.params.allowSwipeToNext === !1 && _.params.grabCursor && _.unsetGrabCursor()
                    ...
                    _.params.allowSwipeToNext = !0, _.params.allowSwipeToPrev === !0 && _.params.grabCursor && _.setGrabCursor()
                }, _.unlockSwipeToPrev = function() {
                    _.params.allowSwipeToPrev = !0, _.params.allowSwipeToNext === !0 && _.params.grabCursor && _.setGrabCursor()
                ...
                }, _.params.grabCursor && _.setGrabCursor(), _.imagesToLoad = [], _.imagesLoaded = 0, _.loadImage = function(e, t, i, n, o, a) {
                    function s() {
                        a && a()
                    }
                    var r;
                    e.complete && o ? s() : t ? (r = new window.Image, r.onload = s, r.onerror = s, n && (r.sizes = n), i && (r.srcset = i), t && (r.src = t)) : s()
                    ...
                    return void 0 === _.autoplayTimeoutId && !!_.params.autoplay && !_.autoplaying && (_.autoplaying = !0, _.emit("onAutoplayStart", _), void s())
                    ...
                    _.autoplayPaused || (_.autoplayTimeoutId && clearTimeout(_.autoplayTimeoutId), _.autoplayPaused = !0, 0 === e ? (_.autoplayPaused = !1, s()) : _.wrapper.transitionEnd(function() {
                        _ && (_.autoplayPaused = !1, _.autoplaying ? s() : _.stopAutoplay())
                    }))
                    ...
                    if (void 0 !== _.size) {
                        ...
                        var s;
                        _.params.slidesPerColumn > 1 && (s = Math.floor(_.slides.length / _.params.slidesPerColumn) === _.slides.length / _.params.slidesPerColumn ? _.slides.length : Math.ceil(_.slides.length / _.params.slidesPerColumn) * _.params.slidesPerColumn, "auto" !== _.params.slidesPerView && "row" === _.params.slidesPerColumnFill && (s = Math.max(s, _.params.slidesPerView * _.params.slidesPerColumn)));
                        var r, l = _.params.slidesPerColumn,
                            c = s / l,
                        ...
                        for (e = 0; e < _.slides.length; e++) {
                            ...
                            if (_.params.slidesPerColumn > 1) {
                                var u, h, f;
                                "column" === _.params.slidesPerColumnFill ? (h = Math.floor(e / l), f = e - h * l, (h > p || h === p && f === l - 1) && ++f >= l && (f = 0, h++), u = h + f * s / l, d.css({
                                    "-webkit-box-ordinal-group": u,
                                    "-moz-box-ordinal-group": u,
                                    "-ms-flex-order": u,
                                    "-webkit-order": u,
                                    order: u
                                })) : (f = Math.floor(e / c), h = e - f * c), d.css("margin-" + (_.isHorizontal() ? "top" : "left"), 0 !== f && _.params.spaceBetween && _.params.spaceBetween + "px").attr("data-swiper-column", h).attr("data-swiper-row", f)
                            }
                            "none" !== d.css("display") && ("auto" === _.params.slidesPerView ? (r = _.isHorizontal() ? d.outerWidth(!0) : d.outerHeight(!0), _.params.roundLengths && (r = a(r))) : (r = (_.size - (_.params.slidesPerView - 1) * t) / _.params.slidesPerView, _.params.roundLengths && (r = a(r)), _.isHorizontal() ? _.slides[e].style.width = r + "px" : _.slides[e].style.height = r + "px"), _.slides[e].swiperSlideSize = r, _.slidesSizesGrid.push(r), _.params.centeredSlides ? (i = i + r / 2 + n / 2 + t, 0 === n && 0 !== e && (i = i - _.size / 2 - t), 0 === e && (i = i - _.size / 2 - t), Math.abs(i) < .001 && (i = 0), o % _.params.slidesPerGroup == 0 && _.snapGrid.push(i), _.slidesGrid.push(i)) : (o % _.params.slidesPerGroup == 0 && _.snapGrid.push(i), _.slidesGrid.push(i), i = i + r + t), _.virtualSize += r + t, n = r, o++)
                        }
                        ...
                        })), _.params.slidesPerColumn > 1 && (_.virtualSize = (r + _.params.spaceBetween) * s, _.virtualSize = Math.ceil(_.virtualSize / _.params.slidesPerColumn) - _.params.spaceBetween, _.isHorizontal() ? _.wrapper.css({
                            width: _.virtualSize + _.params.spaceBetween + "px"
                        }) : _.wrapper.css({
                            height: _.virtualSize + _.params.spaceBetween + "px"
                    ...
                    var e, t, i = 1;
                    if (_.params.centeredSlides) {
                        var n, o = _.slides[_.activeIndex].swiperSlideSize;
                        for (e = _.activeIndex + 1; e < _.slides.length; e++) _.slides[e] && !n && (o += _.slides[e].swiperSlideSize, i++, o > _.size && (n = !0));
                        for (t = _.activeIndex - 1; t >= 0; t--) _.slides[t] && !n && (o += _.slides[t].swiperSlideSize, i++, o > _.size && (n = !0))
                    } else
                        for (e = _.activeIndex + 1; e < _.slides.length; e++) _.slidesGrid[e] - _.slidesGrid[_.activeIndex] < _.size && i++;
                    return i
                    ...
                    if (void 0 === e && (e = _.translate || 0), 0 !== _.slides.length) {
                        ...
                        for (var i = 0; i < _.slides.length; i++) {
                            var n = _.slides[i],
                                o = (t + (_.params.centeredSlides ? _.minTranslate() : 0) - n.swiperSlideOffset) / (n.swiperSlideSize + _.params.spaceBetween);
                            if (_.params.watchSlidesVisibility) {
                                var a = -(t - n.swiperSlideOffset),
                                    s = a + _.slidesSizesGrid[i];
                                (a >= 0 && a < _.size || s > 0 && s <= _.size || a <= 0 && s >= _.size) && _.slides.eq(i).addClass(_.params.slideVisibleClass)
                            }
                            n.progress = _.rtl ? -o : o
                        }
                    }
                    ...
                    var t = _.maxTranslate() - _.minTranslate(),
                        i = _.isBeginning,
                        n = _.isEnd;
                    0 === t ? (_.progress = 0, _.isBeginning = _.isEnd = !0) : (_.progress = (e - _.minTranslate()) / t, _.isBeginning = _.progress <= 0, _.isEnd = _.progress >= 1), _.isBeginning && !i && _.emit("onReachBeginning", _), _.isEnd && !n && _.emit("onReachEnd", _), _.params.watchSlidesProgress && _.updateSlidesProgress(e), _.emit("onProgress", _, _.progress)
                }, _.updateActiveIndex = function() {
                    var e, t, i, n = _.rtl ? _.translate : -_.translate;
                    for (t = 0; t < _.slidesGrid.length; t++) void 0 !== _.slidesGrid[t + 1] ? n >= _.slidesGrid[t] && n < _.slidesGrid[t + 1] - (_.slidesGrid[t + 1] - _.slidesGrid[t]) / 2 ? e = t : n >= _.slidesGrid[t] && n < _.slidesGrid[t + 1] && (e = t + 1) : n >= _.slidesGrid[t] && (e = t);
                    _.params.normalizeSlideIndex && (e < 0 || void 0 === e) && (e = 0), i = Math.floor(e / _.params.slidesPerGroup), i >= _.snapGrid.length && (i = _.snapGrid.length - 1), e !== _.activeIndex && (_.snapIndex = i, _.previousIndex = _.activeIndex, _.activeIndex = e, _.updateClasses(), _.updateRealIndex())
                    ...
                    t.addClass(_.params.slideActiveClass), o.loop && (t.hasClass(_.params.slideDuplicateClass) ? _.wrapper.children("." + _.params.slideClass + ":not(." + _.params.slideDuplicateClass + ')[data-swiper-slide-index="' + _.realIndex + '"]').addClass(_.params.slideDuplicateActiveClass) : _.wrapper.children("." + _.params.slideClass + "." + _.params.slideDuplicateClass + '[data-swiper-slide-index="' + _.realIndex + '"]').addClass(_.params.slideDuplicateActiveClass));
                    ...
                    if (_.params.loop && 0 === n.length && (n = _.slides.eq(-1), n.addClass(_.params.slidePrevClass)), o.loop && (i.hasClass(_.params.slideDuplicateClass) ? _.wrapper.children("." + _.params.slideClass + ":not(." + _.params.slideDuplicateClass + ')[data-swiper-slide-index="' + i.attr("data-swiper-slide-index") + '"]').addClass(_.params.slideDuplicateNextClass) : _.wrapper.children("." + _.params.slideClass + "." + _.params.slideDuplicateClass + '[data-swiper-slide-index="' + i.attr("data-swiper-slide-index") + '"]').addClass(_.params.slideDuplicateNextClass), n.hasClass(_.params.slideDuplicateClass) ? _.wrapper.children("." + _.params.slideClass + ":not(." + _.params.slideDuplicateClass + ')[data-swiper-slide-index="' + n.attr("data-swiper-slide-index") + '"]').addClass(_.params.slideDuplicatePrevClass) : _.wrapper.children("." + _.params.slideClass + "." + _.params.slideDuplicateClass + '[data-swiper-slide-index="' + n.attr("data-swiper-slide-index") + '"]').addClass(_.params.slideDuplicatePrevClass)), _.paginationContainer && _.paginationContainer.length > 0) {
                        var a, s = _.params.loop ? Math.ceil((_.slides.length - 2 * _.loopedSlides) / _.params.slidesPerGroup) : _.snapGrid.length;
                        if (_.params.loop ? (a = Math.ceil((_.activeIndex - _.loopedSlides) / _.params.slidesPerGroup), a > _.slides.length - 1 - 2 * _.loopedSlides && (a -= _.slides.length - 2 * _.loopedSlides), a > s - 1 && (a -= s), a < 0 && "bullets" !== _.params.paginationType && (a = s + a)) : a = void 0 !== _.snapIndex ? _.snapIndex : _.activeIndex || 0, "bullets" === _.params.paginationType && _.bullets && _.bullets.length > 0 && (_.bullets.removeClass(_.params.bulletActiveClass), _.paginationContainer.length > 1 ? _.bullets.each(function() {
                            e(this).index() === a && e(this).addClass(_.params.bulletActiveClass)
                        }) : _.bullets.eq(a).addClass(_.params.bulletActiveClass)), "fraction" === _.params.paginationType && (_.paginationContainer.find("." + _.params.paginationCurrentClass).text(a + 1), _.paginationContainer.find("." + _.params.paginationTotalClass).text(s)), "progress" === _.params.paginationType) {
                            var r = (a + 1) / s,
                                l = r,
                                c = 1;
                            _.isHorizontal() || (c = r, l = 1), _.paginationContainer.find("." + _.params.paginationProgressbarClass).transform("translate3d(0,0,0) scaleX(" + l + ") scaleY(" + c + ")").transition(_.params.speed)
                        }
                        "custom" === _.params.paginationType && _.params.paginationCustomRender && (_.paginationContainer.html(_.params.paginationCustomRender(_, a + 1, s)), _.emit("onPaginationRendered", _, _.paginationContainer[0]))
                    }
                    ...
                    if (_.params.pagination && _.paginationContainer && _.paginationContainer.length > 0) {
                        ...
                        if ("bullets" === _.params.paginationType) {
                            for (var t = _.params.loop ? Math.ceil((_.slides.length - 2 * _.loopedSlides) / _.params.slidesPerGroup) : _.snapGrid.length, i = 0; i < t; i++) e += _.params.paginationBulletRender ? _.params.paginationBulletRender(_, i, _.params.bulletClass) : "<" + _.params.paginationElement + ' class="' + _.params.bulletClass + '"></' + _.params.paginationElement + ">";
                    ...
                    function t() {
                        _.rtl, _.translate, i = Math.min(Math.max(_.translate, _.maxTranslate()), _.minTranslate()), _.setWrapperTranslate(i), _.updateActiveIndex(), _.updateClasses()
                    }
                    if (_) {
                    ...
                    if (_.params.freeMode) {
                        var o = Math.min(Math.max(_.translate, _.maxTranslate()), _.minTranslate());
                        _.setWrapperTranslate(o), _.updateActiveIndex(), _.updateClasses(), _.params.autoHeight && _.updateAutoHeight()
                    } else _.updateClasses(), n = ("auto" === _.params.slidesPerView || _.params.slidesPerView > 1) && _.isEnd && !_.params.centeredSlides ? _.slideTo(_.slides.length - 1, 0, !1, !0) : _.slideTo(_.activeIndex, 0, !1, !0);
                    ...
                    var t = e ? "off" : "on",
                        ...
                        a = _.support.touch ? n : document,
                        s = !!_.params.nested;
                    if (_.browser.ie) n[i](_.touchEvents.start, _.onTouchStart, !1), a[i](_.touchEvents.move, _.onTouchMove, s), a[i](_.touchEvents.end, _.onTouchEnd, !1);
                    else {
                        if (_.support.touch) {
                            var r = !("touchstart" !== _.touchEvents.start || !_.support.passiveListener || !_.params.passiveListeners) && {
                                passive: !0,
                                capture: !1
                            };
                            n[i](_.touchEvents.start, _.onTouchStart, r), n[i](_.touchEvents.move, _.onTouchMove, s), n[i](_.touchEvents.end, _.onTouchEnd, r)
                        }(o.simulateTouch && !_.device.ios && !_.device.android || o.simulateTouch && !_.support.touch && _.device.ios) && (n[i]("mousedown", _.onTouchStart, !1), document[i]("mousemove", _.onTouchMove, s), document[i]("mouseup", _.onTouchEnd, !1))
                    }
                    window[i]("resize", _.onResize), _.params.nextButton && _.nextButton && _.nextButton.length > 0 && (_.nextButton[t]("click", _.onClickNext), _.params.a11y && _.a11y && _.nextButton[t]("keydown", _.a11y.onEnterKey)), _.params.prevButton && _.prevButton && _.prevButton.length > 0 && (_.prevButton[t]("click", _.onClickPrev), _.params.a11y && _.a11y && _.prevButton[t]("keydown", _.a11y.onEnterKey)), _.params.pagination && _.params.paginationClickable && (_.paginationContainer[t]("click", "." + _.params.bulletClass, _.onClickIndex), _.params.a11y && _.a11y && _.paginationContainer[t]("keydown", "." + _.params.bulletClass, _.a11y.onEnterKey)), (_.params.preventClicks || _.params.preventClicksPropagation) && n[i]("click", _.preventClicks, !0)
                    ...
                    var i = r(t, "." + _.params.slideClass),
                        n = !1;
                    if (i)
                        for (var o = 0; o < _.slides.length; o++) _.slides[o] === i && (n = !0);
                    ...
                    if (_.clickedSlide = i, _.clickedIndex = e(i).index(), _.params.slideToClickedSlide && void 0 !== _.clickedIndex && _.clickedIndex !== _.activeIndex) {
                        var a, s = _.clickedIndex,
                            l = "auto" === _.params.slidesPerView ? _.currentSlidesPerView() : _.params.slidesPerView;
                        if (_.params.loop) {
                            if (_.animating) return;
                            a = parseInt(e(_.clickedSlide).attr("data-swiper-slide-index"), 10), _.params.centeredSlides ? s < _.loopedSlides - l / 2 || s > _.slides.length - _.loopedSlides + l / 2 ? (_.fixLoop(), s = _.wrapper.children("." + _.params.slideClass + '[data-swiper-slide-index="' + a + '"]:not(.' + _.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function() {
                                _.slideTo(s)
                            }, 0)) : _.slideTo(s) : s > _.slides.length - l ? (_.fixLoop(), s = _.wrapper.children("." + _.params.slideClass + '[data-swiper-slide-index="' + a + '"]:not(.' + _.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function() {
                                _.slideTo(s)
                            }, 0)) : _.slideTo(s)
                        } else _.slideTo(s)
                    }
                };
                var x, S, T, I, k, A, E, P, j, M, z = "input, select, textarea, button, video",
                    D = Date.now(),
                    O = [];
                ...
                _.onTouchStart = function(t) {
                    if (t.originalEvent && (t = t.originalEvent), (B = "touchstart" === t.type) || !("which" in t) || 3 !== t.which) {
                        ...
                        if (!_.params.swipeHandler || r(t, _.params.swipeHandler)) {
                            ...
                            if (!(_.device.ios && _.params.iOSEdgeSwipeDetection && i <= _.params.iOSEdgeSwipeThreshold)) {
                                if (x = !0, S = !1, T = !0, k = void 0, L = void 0, _.touches.startX = i, _.touches.startY = n, I = Date.now(), _.allowClick = !0, _.updateContainerSize(), _.swipeDirection = void 0, _.params.threshold > 0 && (P = !1), "touchstart" !== t.type) {
                                    var o = !0;
                    ...
                    if (t.originalEvent && (t = t.originalEvent), !B || "mousemove" !== t.type) {
                        ...
                        if (_.params.onlyExternal) return _.allowClick = !1, void(x && (_.touches.startX = _.touches.currentX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, _.touches.startY = _.touches.currentY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, I = Date.now()));
                        if (B && _.params.touchReleaseOnEdges && !_.params.loop)
                            if (_.isHorizontal()) {
                        ...
                        if (B && document.activeElement && t.target === document.activeElement && e(t.target).is(z)) return S = !0, void(_.allowClick = !1);
                        if (T && _.emit("onTouchMove", _, t), !(t.targetTouches && t.targetTouches.length > 1)) {
                            if (_.touches.currentX = "touchmove" === t.type ? t.targetTouches[0].pageX : t.pageX, _.touches.currentY = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, void 0 === k) {
                                var i;
                                _.isHorizontal() && _.touches.currentY === _.touches.startY || !_.isHorizontal() && _.touches.currentX === _.touches.startX ? k = !1 : (i = 180 * Math.atan2(Math.abs(_.touches.currentY - _.touches.startY), Math.abs(_.touches.currentX - _.touches.startX)) / Math.PI, k = _.isHorizontal() ? i > _.params.touchAngle : 90 - i > _.params.touchAngle)
                            }
                            if (k && _.emit("onTouchMoveOpposite", _, t), void 0 === L && (_.touches.currentX === _.touches.startX && _.touches.currentY === _.touches.startY || (L = !0)), x) {
                                if (k) return void(x = !1);
                                if (L) {
                                    _.allowClick = !1, _.emit("onSliderMove", _, t), t.preventDefault(), _.params.touchMoveStopPropagation && !_.params.nested && t.stopPropagation(), S || (o.loop && _.fixLoop(), E = _.getWrapperTranslate(), _.setWrapperTransition(0), _.animating && _.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), _.params.autoplay && _.autoplaying && (_.params.autoplayDisableOnInteraction ? _.stopAutoplay() : _.pauseAutoplay()), M = !1, !_.params.grabCursor || _.params.allowSwipeToNext !== !0 && _.params.allowSwipeToPrev !== !0 || _.setGrabCursor(!0)), S = !0;
                                    var n = _.touches.diff = _.isHorizontal() ? _.touches.currentX - _.touches.startX : _.touches.currentY - _.touches.startY;
                                    n *= _.params.touchRatio, _.rtl && (n = -n), _.swipeDirection = n > 0 ? "prev" : "next", A = n + E;
                                    var a = !0;
                                    if (n > 0 && A > _.minTranslate() ? (a = !1, _.params.resistance && (A = _.minTranslate() - 1 + Math.pow(-_.minTranslate() + E + n, _.params.resistanceRatio))) : n < 0 && A < _.maxTranslate() && (a = !1, _.params.resistance && (A = _.maxTranslate() + 1 - Math.pow(_.maxTranslate() - E - n, _.params.resistanceRatio))), a && (t.preventedByNestedSwiper = !0), !_.params.allowSwipeToNext && "next" === _.swipeDirection && A < E && (A = E), !_.params.allowSwipeToPrev && "prev" === _.swipeDirection && A > E && (A = E), _.params.threshold > 0) {
                                        if (!(Math.abs(n) > _.params.threshold || P)) return void(A = E);
                                        if (!P) return P = !0, _.touches.startX = _.touches.currentX, _.touches.startY = _.touches.currentY, A = E, void(_.touches.diff = _.isHorizontal() ? _.touches.currentX - _.touches.startX : _.touches.currentY - _.touches.startY)
                                    }
                                    _.params.followFinger && ((_.params.freeMode || _.params.watchSlidesProgress) && _.updateActiveIndex(), _.params.freeMode && (0 === O.length && O.push({
                                        position: _.touches[_.isHorizontal() ? "startX" : "startY"],
                                        time: I
                                    }), O.push({
                                        position: _.touches[_.isHorizontal() ? "currentX" : "currentY"],
                                        time: (new window.Date).getTime()
                                    })), _.updateProgress(A), _.setWrapperTranslate(A))
                                }
                            }
                        }
                    }
                }, _.onTouchEnd = function(t) {
                    if (t.originalEvent && (t = t.originalEvent), T && _.emit("onTouchEnd", _, t), T = !1, x) {
                        _.params.grabCursor && S && x && (_.params.allowSwipeToNext === !0 || _.params.allowSwipeToPrev === !0) && _.setGrabCursor(!1);
                        var i = Date.now(),
                            n = i - I;
                        if (_.allowClick && (_.updateClickedSlide(t), _.emit("onTap", _, t), n < 300 && i - D > 300 && (j && clearTimeout(j), j = setTimeout(function() {
                        ...
                        }, 300)), n < 300 && i - D < 300 && (j && clearTimeout(j), _.emit("onDoubleTap", _, t))), D = Date.now(), setTimeout(function() {
                            _ && (_.allowClick = !0)
                        }, 0), !x || !S || !_.swipeDirection || 0 === _.touches.diff || A === E) return void(x = S = !1);
                        x = S = !1;
                        var o;
                        if (o = _.params.followFinger ? _.rtl ? _.translate : -_.translate : -A, _.params.freeMode) {
                            if (o < -_.minTranslate()) return void _.slideTo(_.activeIndex);
                            if (o > -_.maxTranslate()) return void(_.slides.length < _.snapGrid.length ? _.slideTo(_.snapGrid.length - 1) : _.slideTo(_.slides.length - 1));
                            if (_.params.freeModeMomentum) {
                                if (O.length > 1) {
                                    var a = O.pop(),
                                        s = O.pop(),
                                        r = a.position - s.position,
                                        l = a.time - s.time;
                                    _.velocity = r / l, _.velocity = _.velocity / 2, Math.abs(_.velocity) < _.params.freeModeMinimumVelocity && (_.velocity = 0), (l > 150 || (new window.Date).getTime() - a.time > 300) && (_.velocity = 0)
                                } else _.velocity = 0;
                                _.velocity = _.velocity * _.params.freeModeMomentumVelocityRatio, O.length = 0;
                                ...
                                if (d < _.maxTranslate()) _.params.freeModeMomentumBounce ? (d + _.maxTranslate() < -f && (d = _.maxTranslate() - f), u = _.maxTranslate(), h = !0, M = !0) : d = _.maxTranslate();
                                else if (d > _.minTranslate()) _.params.freeModeMomentumBounce ? (d - _.minTranslate() > f && (d = _.minTranslate() + f), u = _.minTranslate(), h = !0, M = !0) : d = _.minTranslate();
                                    ...
                                    for (m = 0; m < _.snapGrid.length; m += 1)
                                        if (_.snapGrid[m] > -d) {
                                            g = m;
                                            break
                                        } d = Math.abs(_.snapGrid[g] - d) < Math.abs(_.snapGrid[g - 1] - d) || "next" === _.swipeDirection ? _.snapGrid[g] : _.snapGrid[g - 1], _.rtl || (d = -d)
                                }
                                ...
                                _.params.freeModeMomentumBounce && h ? (_.updateProgress(u), _.setWrapperTransition(c), _.setWrapperTranslate(d), _.onTransitionStart(), _.animating = !0, _.wrapper.transitionEnd(function() {
                                    _ && M && (_.emit("onMomentumBounce", _), _.setWrapperTransition(_.params.speed), _.setWrapperTranslate(u), _.wrapper.transitionEnd(function() {
                                        _ && _.onTransitionEnd()
                                    }))
                                })) : _.velocity ? (_.updateProgress(d), _.setWrapperTransition(c), _.setWrapperTranslate(d), _.onTransitionStart(), _.animating || (_.animating = !0, _.wrapper.transitionEnd(function() {
                                    _ && _.onTransitionEnd()
                                }))) : _.updateProgress(d), _.updateActiveIndex()
                            }
                            return void((!_.params.freeModeMomentum || n >= _.params.longSwipesMs) && (_.updateProgress(), _.updateActiveIndex()))
                        }
                        var v, b = 0,
                            w = _.slidesSizesGrid[0];
                        for (v = 0; v < _.slidesGrid.length; v += _.params.slidesPerGroup) void 0 !== _.slidesGrid[v + _.params.slidesPerGroup] ? o >= _.slidesGrid[v] && o < _.slidesGrid[v + _.params.slidesPerGroup] && (b = v, w = _.slidesGrid[v + _.params.slidesPerGroup] - _.slidesGrid[v]) : o >= _.slidesGrid[v] && (b = v, w = _.slidesGrid[_.slidesGrid.length - 1] - _.slidesGrid[_.slidesGrid.length - 2]);
                        var y = (o - _.slidesGrid[b]) / w;
                        if (n > _.params.longSwipesMs) {
                            if (!_.params.longSwipes) return void _.slideTo(_.activeIndex);
                            "next" === _.swipeDirection && (y >= _.params.longSwipesRatio ? _.slideTo(b + _.params.slidesPerGroup) : _.slideTo(b)), "prev" === _.swipeDirection && (y > 1 - _.params.longSwipesRatio ? _.slideTo(b + _.params.slidesPerGroup) : _.slideTo(b))
                        } else {
                            if (!_.params.shortSwipes) return void _.slideTo(_.activeIndex);
                            "next" === _.swipeDirection && _.slideTo(b + _.params.slidesPerGroup), "prev" === _.swipeDirection && _.slideTo(b)
                        }
                    }
                    ...
                    var o = -_.snapGrid[_.snapIndex];
                    if (_.params.autoplay && _.autoplaying && (n || !_.params.autoplayDisableOnInteraction ? _.pauseAutoplay(t) : _.stopAutoplay()), _.updateProgress(o), _.params.normalizeSlideIndex)
                        for (var a = 0; a < _.slidesGrid.length; a++) - Math.floor(100 * o) >= Math.floor(100 * _.slidesGrid[a]) && (e = a);
                    return !(!_.params.allowSwipeToNext && o < _.translate && o < _.minTranslate() || !_.params.allowSwipeToPrev && o > _.translate && o > _.maxTranslate() && (_.activeIndex || 0) !== e || (void 0 === t && (t = _.params.speed), _.previousIndex = _.activeIndex || 0, _.activeIndex = e, _.updateRealIndex(), _.rtl && -o === _.translate || !_.rtl && o === _.translate ? (_.params.autoHeight && _.updateAutoHeight(), _.updateClasses(), "slide" !== _.params.effect && _.setWrapperTranslate(o), 1) : (_.updateClasses(), _.onTransitionStart(i), 0 === t || _.browser.lteIE9 ? (_.setWrapperTranslate(o), _.setWrapperTransition(0), _.onTransitionEnd(i)) : (_.setWrapperTranslate(o), _.setWrapperTransition(t), _.animating || (_.animating = !0, _.wrapper.transitionEnd(function() {
                    ...
                    var n = 0,
                        o = 0;
                    _.isHorizontal() ? n = _.rtl ? -e : e : o = e, _.params.roundLengths && (n = a(n), o = a(o)), _.params.virtualTranslate || (_.support.transforms3d ? _.wrapper.transform("translate3d(" + n + "px, " + o + "px, 0px)") : _.wrapper.transform("translate(" + n + "px, " + o + "px)")), _.translate = _.isHorizontal() ? n : o;
                    var s, r = _.maxTranslate() - _.minTranslate();
                    s = 0 === r ? 0 : (e - _.minTranslate()) / r, s !== _.progress && _.updateProgress(e), t && _.updateActiveIndex(), "slide" !== _.params.effect && _.effects[_.params.effect] && _.effects[_.params.effect].setTranslate(_.translate), _.params.parallax && _.parallax && _.parallax.setTranslate(_.translate), _.params.scrollbar && _.scrollbar && _.scrollbar.setTranslate(_.translate), _.params.control && _.controller && _.controller.setTranslate(_.translate, i), _.emit("onSetTranslate", _, _.translate)
                }, _.getTranslate = function(e, t) {
                    var i, n, o, a;
                    return void 0 === t && (t = "x"), _.params.virtualTranslate ? _.rtl ? -_.translate : _.translate : (o = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? (n = o.transform || o.webkitTransform, n.split(",").length > 6 && (n = n.split(", ").map(function(e) {
                        return e.replace(",", ".")
                    }).join(", ")), a = new window.WebKitCSSMatrix("none" === n ? "" : n)) : (a = o.MozTransform || o.OTransform || o.MsTransform || o.msTransform || o.transform || o.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), i = a.toString().split(",")), "x" === t && (n = window.WebKitCSSMatrix ? a.m41 : 16 === i.length ? parseFloat(i[12]) : parseFloat(i[4])), "y" === t && (n = window.WebKitCSSMatrix ? a.m42 : 16 === i.length ? parseFloat(i[13]) : parseFloat(i[5])), _.rtl && n && (n = -n), n || 0)
                    ...
                    if (_.params.observeParents)
                        for (var e = _.container.parents(), t = 0; t < e.length; t++) l(e[t]);
                    l(_.container[0], {
                        childList: !1
                    }), l(_.wrapper[0], {
                        attributes: !1
                    ...
                    for (t.each(function(i, a) {
                        var s = e(this);
                        i < _.loopedSlides && o.push(a), i < t.length && i >= t.length - _.loopedSlides && n.push(a), s.attr("data-swiper-slide-index", i)
                    }), i = 0; i < o.length; i++) _.wrapper.append(e(o[i].cloneNode(!0)).addClass(_.params.slideDuplicateClass));
                        ...
                        setTranslate: function() {
                            for (var t = 0; t < _.slides.length; t++) {
                                ...
                                var o = i[0].swiperSlideOffset,
                                    ...
                                    l = -o,
                                    c = 0;
                                if (_.isHorizontal() ? _.rtl && (s = -s) : (c = l, l = 0, r = -s, s = 0), i[0].style.zIndex = -Math.abs(Math.round(n)) + _.slides.length, _.params.flip.slideShadows) {
                                    ...
                                    0 === p.length && (p = e('<div class="swiper-slide-shadow-' + (_.isHorizontal() ? "left" : "top") + '"></div>'), i.append(p)), 0 === d.length && (d = e('<div class="swiper-slide-shadow-' + (_.isHorizontal() ? "right" : "bottom") + '"></div>'), i.append(d)), p.length && (p[0].style.opacity = Math.max(-n, 0)), d.length && (d[0].style.opacity = Math.max(n, 0))
                                }
                                i.transform("translate3d(" + l + "px, " + c + "px, 0px) rotateX(" + r + "deg) rotateY(" + s + "deg)")
                            }
                        },
                        ...
                        setTranslate: function() {
                            ...
                            for (var n = 0; n < _.slides.length; n++) {
                                var o = _.slides.eq(n),
                                    a = 90 * n,
                                    s = Math.floor(a / 360);
                                _.rtl && (a = -a, s = Math.floor(-a / 360));
                                var r = Math.max(Math.min(o[0].progress, 1), -1),
                                    l = 0,
                                    c = 0,
                                    p = 0;
                                n % 4 == 0 ? (l = 4 * -s * _.size, p = 0) : (n - 1) % 4 == 0 ? (l = 0, p = 4 * -s * _.size) : (n - 2) % 4 == 0 ? (l = _.size + 4 * s * _.size, p = _.size) : (n - 3) % 4 == 0 && (l = -_.size, p = 3 * _.size + 4 * _.size * s), _.rtl && (l = -l), _.isHorizontal() || (c = l, l = 0);
                                var d = "rotateX(" + (_.isHorizontal() ? 0 : -a) + "deg) rotateY(" + (_.isHorizontal() ? a : 0) + "deg) translate3d(" + l + "px, " + c + "px, " + p + "px)";
                                if (r <= 1 && r > -1 && (i = 90 * n + 90 * r, _.rtl && (i = 90 * -n - 90 * r)), o.transform(d), _.params.cube.slideShadows) {
                                    var u = _.isHorizontal() ? o.find(".swiper-slide-shadow-left") : o.find(".swiper-slide-shadow-top"),
                                        h = _.isHorizontal() ? o.find(".swiper-slide-shadow-right") : o.find(".swiper-slide-shadow-bottom");
                                    0 === u.length && (u = e('<div class="swiper-slide-shadow-' + (_.isHorizontal() ? "left" : "top") + '"></div>'), o.append(u)), 0 === h.length && (h = e('<div class="swiper-slide-shadow-' + (_.isHorizontal() ? "right" : "bottom") + '"></div>'), o.append(h)), u.length && (u[0].style.opacity = Math.max(-r, 0)), h.length && (h[0].style.opacity = Math.max(r, 0))
                                }
                            }
                            if (_.wrapper.css({
                                ...
                                if (_.isHorizontal()) t.transform("translate3d(0px, " + (_.width / 2 + _.params.cube.shadowOffset) + "px, " + -_.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + _.params.cube.shadowScale + ")");
                                    ...
                                    t.transform("scale3d(" + m + ", 1, " + v + ") translate3d(0px, " + (_.height / 2 + b) + "px, " + -_.height / 2 / v + "px) rotateX(-90deg)")
                                } var w = _.isSafari || _.isUiWebView ? -_.size / 2 : 0;
                            _.wrapper.transform("translate3d(0px,0," + w + "px) rotateX(" + (_.isHorizontal() ? 0 : i) + "deg) rotateY(" + (_.isHorizontal() ? -i : 0) + "deg)")
                        },
                        setTransition: function(e) {
                    ...
                    coverflow: {
                        setTranslate: function() {
                            for (var t = _.translate, i = _.isHorizontal() ? -t + _.width / 2 : -t + _.height / 2, n = _.isHorizontal() ? _.params.coverflow.rotate : -_.params.coverflow.rotate, o = _.params.coverflow.depth, a = 0, s = _.slides.length; a < s; a++) {
                                var r = _.slides.eq(a),
                                    l = _.slidesSizesGrid[a],
                                    c = r[0].swiperSlideOffset,
                                    p = (i - c - l / 2) / l * _.params.coverflow.modifier,
                                    d = _.isHorizontal() ? n * p : 0,
                                    u = _.isHorizontal() ? 0 : n * p,
                                    h = -o * Math.abs(p),
                                    f = _.isHorizontal() ? 0 : _.params.coverflow.stretch * p,
                                    g = _.isHorizontal() ? _.params.coverflow.stretch * p : 0;
                                Math.abs(g) < .001 && (g = 0), Math.abs(f) < .001 && (f = 0), Math.abs(h) < .001 && (h = 0), Math.abs(d) < .001 && (d = 0), Math.abs(u) < .001 && (u = 0);
                                var m = "translate3d(" + g + "px," + f + "px," + h + "px)  rotateX(" + u + "deg) rotateY(" + d + "deg)";
                                if (r.transform(m), r[0].style.zIndex = 1 - Math.abs(Math.round(p)), _.params.coverflow.slideShadows) {
                                    var v = _.isHorizontal() ? r.find(".swiper-slide-shadow-left") : r.find(".swiper-slide-shadow-top"),
                                        b = _.isHorizontal() ? r.find(".swiper-slide-shadow-right") : r.find(".swiper-slide-shadow-bottom");
                                    0 === v.length && (v = e('<div class="swiper-slide-shadow-' + (_.isHorizontal() ? "left" : "top") + '"></div>'), r.append(v)), 0 === b.length && (b = e('<div class="swiper-slide-shadow-' + (_.isHorizontal() ? "right" : "bottom") + '"></div>'), r.append(b)), v.length && (v[0].style.opacity = p > 0 ? p : 0), b.length && (b[0].style.opacity = -p > 0 ? -p : 0)
                                }
                            }
                            _.browser.ie && (_.wrapper[0].style.perspectiveOrigin = i + "px 50%")
                        },
                        setTransition: function(e) {
                    ...
                    loadImageInSlide: function(t, i) {
                        if (void 0 !== t && (void 0 === i && (i = !0), 0 !== _.slides.length)) {
                            var n = _.slides.eq(t),
                                o = n.find("." + _.params.lazyLoadingClass + ":not(." + _.params.lazyStatusLoadedClass + "):not(." + _.params.lazyStatusLoadingClass + ")");
                            !n.hasClass(_.params.lazyLoadingClass) || n.hasClass(_.params.lazyStatusLoadedClass) || n.hasClass(_.params.lazyStatusLoadingClass) || (o = o.add(n[0])), 0 !== o.length && o.each(function() {
                                var t = e(this);
                                ...
                                var o = t.attr("data-background"),
                                    ...
                                    r = t.attr("data-sizes");
                                _.loadImage(t[0], a || o, s, r, !1, function() {
                                    if (void 0 !== _ && null !== _ && _) {
                                        if (o ? (t.css("background-image", 'url("' + o + '")'), t.removeAttr("data-background")) : (s && (t.attr("srcset", s), t.removeAttr("data-srcset")), r && (t.attr("sizes", r), t.removeAttr("data-sizes")), a && (t.attr("src", a), t.removeAttr("data-src"))), t.addClass(_.params.lazyStatusLoadedClass).removeClass(_.params.lazyStatusLoadingClass), n.find("." + _.params.lazyPreloaderClass + ", ." + _.params.preloaderClass).remove(), _.params.loop && i) {
                    ...
                    load: function() {
                        var t, i = _.params.slidesPerView;
                        if ("auto" === i && (i = 0), _.lazy.initialImageLoaded || (_.lazy.initialImageLoaded = !0), _.params.watchSlidesVisibility) _.wrapper.children("." + _.params.slideVisibleClass).each(function() {
                            _.lazy.loadImageInSlide(e(this).index())
                        });
                        else if (i > 1)
                            for (t = _.activeIndex; t < _.activeIndex + i; t++) _.slides[t] && _.lazy.loadImageInSlide(t);
                        ...
                        if (_.params.lazyLoadingInPrevNext)
                            if (i > 1 || _.params.lazyLoadingInPrevNextAmount && _.params.lazyLoadingInPrevNextAmount > 1) {
                                var n = _.params.lazyLoadingInPrevNextAmount,
                                    o = i,
                                    a = Math.min(_.activeIndex + o + Math.max(n, o), _.slides.length),
                                    s = Math.max(_.activeIndex - Math.max(o, n), 0);
                                for (t = _.activeIndex + i; t < a; t++) _.slides[t] && _.lazy.loadImageInSlide(t);
                                for (t = s; t < _.activeIndex; t++) _.slides[t] && _.lazy.loadImageInSlide(t)
                            } else {
                    ...
                    setDragPosition: function(e) {
                        var t = _.scrollbar,
                            i = _.isHorizontal() ? "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX || e.clientX : "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY || e.clientY,
                            n = i - t.track.offset()[_.isHorizontal() ? "left" : "top"] - t.dragSize / 2,
                            o = -_.minTranslate() * t.moveDivider,
                            a = -_.maxTranslate() * t.moveDivider;
                        n < o ? n = o : n > a && (n = a), n = -n / t.moveDivider, _.updateProgress(n), _.setWrapperTranslate(n, !0)
                    },
                    ...
                    draggableEvents: function() {
                        return _.params.simulateTouch !== !1 || _.support.touch ? _.touchEvents : _.touchEventsDesktop
                    }(),
                    ...
                    setTranslate: function() {
                        if (_.params.scrollbar) {
                            ...
                            e = (t.trackSize - t.dragSize) * _.progress, _.rtl && _.isHorizontal() ? (e = -e, e > 0 ? (i = t.dragSize - e, e = 0) : -e + t.dragSize > t.trackSize && (i = t.trackSize + e)) : e < 0 ? (i = t.dragSize + e, e = 0) : e + t.dragSize > t.trackSize && (i = t.trackSize - e), _.isHorizontal() ? (_.support.transforms3d ? t.drag.transform("translate3d(" + e + "px, 0, 0)") : t.drag.transform("translateX(" + e + "px)"), t.drag[0].style.width = i + "px") : (_.support.transforms3d ? t.drag.transform("translate3d(0px, " + e + "px, 0)") : t.drag.transform("translateY(" + e + "px)"), t.drag[0].style.height = i + "px"), _.params.scrollbarHide && (clearTimeout(t.timeout), t.track[0].style.opacity = 1, t.timeout = setTimeout(function() {
                    ...
                    LinearSpline: function(e, t) {
                        ...
                        this.x.length, this.interpolate = function(e) {
                            return e ? (o = i(this.x, e), n = o - 1, (e - this.x[n]) * (this.y[o] - this.y[n]) / (this.x[o] - this.x[n]) + this.y[n]) : 0
                        }
                    },
                    ...
                    setTransition: function(e, i) {
                        ...
                        var o, a = _.params.control;
                        if (Array.isArray(a))
                            for (o = 0; o < a.length; o++) a[o] !== i && a[o] instanceof t && n(a[o]);
                        ...
                        if (_.params.hashnav && !_.params.history) {
                            ...
                            if (e)
                                for (var t = 0, i = _.slides.length; t < i; t++) {
                                    ...
                                    if (o === e && !n.hasClass(_.params.slideDuplicateClass)) {
                                        var a = n.index();
                    ...
                    scrollToSlide: function(e, t, i) {
                        if (t)
                            for (var n = 0, o = _.slides.length; n < o; n++) {
                                var a = _.slides.eq(n),
                                    s = this.slugify(a.attr("data-history"));
                                if (s === t && !a.hasClass(_.params.slideDuplicateClass)) {
                                    var r = a.index();
                                    _.slideTo(r, e, i)
                                }
                    ...
                    onGestureStart: function(t) {
                        ...
                        if (!(i.gesture.slide && i.gesture.slide.length || (i.gesture.slide = e(this), 0 === i.gesture.slide.length && (i.gesture.slide = _.slides.eq(_.activeIndex)), i.gesture.image = i.gesture.slide.find("img, svg, canvas"), i.gesture.imageWrap = i.gesture.image.parent("." + _.params.zoomContainerClass), i.gesture.zoomMax = i.gesture.imageWrap.attr("data-swiper-zoom") || _.params.zoomMax, 0 !== i.gesture.imageWrap.length))) return void(i.gesture.image = void 0);
                    ...
                    onTouchEnd: function(e, t) {
                        ...
                        if (i.gesture.image && 0 !== i.gesture.image.length) {
                            ...
                            0 !== i.velocity.x && (n = Math.abs((s - i.image.currentX) / i.velocity.x)), 0 !== i.velocity.y && (o = Math.abs((l - i.image.currentY) / i.velocity.y));
                            var c = Math.max(n, o);
                            i.image.currentX = s, i.image.currentY = l;
                            var p = i.image.width * i.scale,
                                d = i.image.height * i.scale;
                            i.image.minX = Math.min(i.gesture.slideWidth / 2 - p / 2, 0), i.image.maxX = -i.image.minX, i.image.minY = Math.min(i.gesture.slideHeight / 2 - d / 2, 0), i.image.maxY = -i.image.minY, i.image.currentX = Math.max(Math.min(i.image.currentX, i.image.maxX), i.image.minX), i.image.currentY = Math.max(Math.min(i.image.currentY, i.image.maxY), i.image.minY), i.gesture.imageWrap.transition(c).transform("translate3d(" + i.image.currentX + "px, " + i.image.currentY + "px,0)")
                        }
                    },
                ...
                for (var W in _.plugins) {
                    var H = _.plugins[W](_, _.params[W]);
                    H && _._plugins.push(H)
                }
                return _.callPlugins = function(e) {
                    ...
                    _.detachEvents(), _.stopAutoplay(), _.params.scrollbar && _.scrollbar && _.params.scrollbarDraggable && _.scrollbar.disableDraggable(), _.params.loop && _.destroyLoop(), t && _.cleanupStyles(), _.disconnectObservers(), _.params.zoom && _.zoom && _.zoom.destroy(), _.params.keyboardControl && _.disableKeyboardControl && _.disableKeyboardControl(), _.params.mousewheelControl && _.disableMousewheelControl && _.disableMousewheelControl(), _.params.a11y && _.a11y && _.a11y.destroy(), _.params.history && !_.params.replaceState && window.removeEventListener("popstate", _.history.setHistoryPopState), _.params.hashnav && _.hashnav && _.hashnav.destroy(), _.emit("onDestroy"), e !== !1 && (_ = null)
                }, _.init(), _
            }
        };
        t.prototype = {
        ...
        for (var i = (function() {
                    ...
                    if (t)
                        if ("string" == typeof t) {
                            ...
                            if (r.indexOf("<") >= 0 && r.indexOf(">") >= 0) {
                                var l = "div";
                                for (0 === r.indexOf("<li") && (l = "ul"), 0 === r.indexOf("<tr") && (l = "tbody"), 0 !== r.indexOf("<td") && 0 !== r.indexOf("<th") || (l = "tr"), 0 === r.indexOf("<tbody") && (l = "table"), 0 === r.indexOf("<option") && (l = "select"), s = document.createElement(l), s.innerHTML = t, o = 0; o < s.childNodes.length; o++) n.push(s.childNodes[o])
                            } else
                                for (a = i || "#" !== t[0] || t.match(/[ .<>:~]/) ? (i || document).querySelectorAll(t) : [document.getElementById(t.split("#")[1])], o = 0; o < a.length; o++) a[o] && n.push(a[o])
            ...
            return e.prototype = {
                ...
                on: function(e, i, n, o) {
                    function a(e) {
                        var o = e.target;
                        if (t(o).is(i)) n.call(o, e);
                        else
                            for (var a = t(o).parents(), s = 0; s < a.length; s++) t(a[s]).is(i) && n.call(a[s], e)
                    }
                    var s, r, l = e.split(" ");
                    for (s = 0; s < this.length; s++)
                        if ("function" == typeof i || i === !1)
                            for ("function" == typeof i && (n = arguments[1], o = arguments[2] || !1), r = 0; r < l.length; r++) this[s].addEventListener(l[r], n, o);
                        else
                            for (r = 0; r < l.length; r++) this[s].dom7LiveListeners || (this[s].dom7LiveListeners = []), this[s].dom7LiveListeners.push({
                                listener: n,
                                liveListener: a
                            }), this[s].addEventListener(l[r], a, o);
                    return this
                },
                off: function(e, t, i, n) {
                    for (var o = e.split(" "), a = 0; a < o.length; a++)
                        for (var s = 0; s < this.length; s++)
                            if ("function" == typeof t || t === !1) "function" == typeof t && (i = arguments[1], n = arguments[2] || !1), this[s].removeEventListener(o[a], i, n);
                            else if (this[s].dom7LiveListeners)
                                for (var r = 0; r < this[s].dom7LiveListeners.length; r++) this[s].dom7LiveListeners[r].listener === i && this[s].removeEventListener(o[a], this[s].dom7LiveListeners[r].liveListener, n);
                    return this
                },
                once: function(e, t, i, n) {
                    ...
                    var a = this;
                    "function" == typeof t && (t = !1, i = arguments[1], n = arguments[2]), a.on(e, t, o, n)
                },
                ...
                is: function(i) {
                    ...
                    if (i.nodeType || i instanceof e) {
                        for (n = i.nodeType ? [i] : i, o = 0; o < n.length; o++)
                            if (n[o] === this[0]) return !0;
                        return !1
                    }
                    return !1
                ...
                prepend: function(t) {
                    ...
                    for (i = 0; i < this.length; i++)
                        if ("string" == typeof t) {
                            var o = document.createElement("div");
                            for (o.innerHTML = t, n = o.childNodes.length - 1; n >= 0; n--) this[i].insertBefore(o.childNodes[n], this[i].childNodes[0])
                        } else if (t instanceof e)
                ...
                insertBefore: function(e) {
                    for (var i = t(e), n = 0; n < this.length; n++)
                        if (1 === i.length) i[0].parentNode.insertBefore(this[n], i[0]);
                            ...
                            for (var o = 0; o < i.length; o++) i[o].parentNode.insertBefore(this[n].cloneNode(!0), i[o])
                },
                insertAfter: function(e) {
                    for (var i = t(e), n = 0; n < this.length; n++)
                        if (1 === i.length) i[0].parentNode.insertBefore(this[n], i[0].nextSibling);
                        else if (i.length > 1)
                            for (var o = 0; o < i.length; o++) i[o].parentNode.insertBefore(this[n].cloneNode(!0), i[o].nextSibling)
                },
                next: function(i) {
                ...
                nextAll: function(i) {
                    ...
                    for (; o.nextElementSibling;) {
                        ...
                        i ? t(a).is(i) && n.push(a) : n.push(a), o = a
                    }
                    return new e(n)
                },
                prev: function(i) {
                ...
                parents: function(e) {
                    for (var i = [], n = 0; n < this.length; n++)
                        for (var o = this[n].parentNode; o;) e ? t(o).is(e) && i.push(o) : i.push(o), o = o.parentNode;
                    return t(t.unique(i))
                },
                find: function(t) {
                    for (var i = [], n = 0; n < this.length; n++)
                        for (var o = this[n].querySelectorAll(t), a = 0; a < o.length; a++) i.push(o[a]);
                    return new e(i)
                },
                children: function(i) {
                    for (var n = [], o = 0; o < this.length; o++)
                        for (var a = this[o].childNodes, s = 0; s < a.length; s++) i ? 1 === a[s].nodeType && t(a[s]).is(i) && n.push(a[s]) : 1 === a[s].nodeType && n.push(a[s]);
                ...
                add: function() {
                    ...
                    for (e = 0; e < arguments.length; e++) {
                        var o = t(arguments[e]);
                        for (i = 0; i < o.length; i++) n[n.length] = o[i], n.length++
                    }
                    return n
                }
    ...
    function(e, t) {
        ...
        function o() {
            if (!s) return !1;
            var e = s.document.body || s.document.documentElement,
                t = e.style,
                i = "transition",
        ...
        var a = {
            ...
            l = function() {
                this.__$emitterPrivate = e({}), this.__$emitterPublic = e({}), this.__instancesLatestArr = [], this.__plugins = {}, this._env = r
            };
        l.prototype = {
            ...
            _plugin: function(t) {
                ...
                if ("string" == typeof t) {
                    ...
                    return n.indexOf(".") > 0 ? o = i.__plugins[n] : e.each(i.__plugins, function(e, t) {
                        if (t.name.substring(t.name.length - n.length - 1) == "." + n) return o = t, !1
                    }), o
                }
            ...
            __init: function(t, i) {
                var n = this;
                if (n._$origin = e(t), n.__options = e.extend(!0, {}, a, i), n.__optionsFormat(), !r.IE || r.IE >= n.__options.IEmin) {
                    var o = null;
                    if (void 0 === n._$origin.data("tooltipster-initialTitle") && (o = n._$origin.attr("title"), void 0 === o && (o = null), n._$origin.data("tooltipster-initialTitle", o)), null !== n.__options.content) n.__contentSet(n.__options.content);
                        ...
                        var s, l = n._$origin.attr("data-tooltip-content");
                        l && (s = e(l)), s && s[0] ? n.__contentSet(s.first()) : n.__contentSet(o)
                    }
                    n._$origin.removeAttr("title").addClass("tooltipstered"), n.__prepareOrigin(), n.__prepareGC(), e.each(n.__options.plugins, function(e, t) {
                        n._plug(t)
                    }), r.hasTouchCapability && e(r.window.document.body).on("touchmove." + n.__namespace + "-triggerOpen", function(e) {
            ...
            __geometry: function() {
                ...
                if (n) {
                    i = e('img[usemap="#' + t._$origin.parent().attr("name") + '"]')
                }
                ...
                if (n) {
                    var p = t._$origin.attr("shape"),
                        d = t._$origin.attr("coords");
                    if (d && (d = d.split(","), e.map(d, function(e, t) {
                        ...
                        case "circle":
                            var u = d[0],
                                ...
                                g = h - f,
                                m = u - f;
                            c.origin.size.height = 2 * f, c.origin.size.width = c.origin.size.height, c.origin.windowOffset.left += m, c.origin.windowOffset.top += g;
                            break;
                        case "rect":
                            var v = d[0],
                                b = d[1],
                                w = d[2],
                                y = d[3];
                            c.origin.size.height = y - b, c.origin.size.width = w - v, c.origin.windowOffset.left += v, c.origin.windowOffset.top += b;
                            break;
                        case "poly":
                            for (var _ = 0, C = 0, x = 0, S = 0, T = "even", I = 0; I < d.length; I++) {
                                var k = d[I];
                                "even" == T ? (k > x && (x = k, 0 === I && (_ = x)), k < _ && (_ = k), T = "odd") : (k > S && (S = k, 1 == I && (C = S)), k < C && (C = k), T = "even")
                            }
                            c.origin.size.height = S - C, c.origin.size.width = x - _, c.origin.windowOffset.left += _, c.origin.windowOffset.top += C
                    }
                }
                var A = function(e) {
            ...
            __optionsFormat: function() {
                return "number" == typeof this.__options.animationDuration && (this.__options.animationDuration = [this.__options.animationDuration, this.__options.animationDuration]), "number" == typeof this.__options.delay && (this.__options.delay = [this.__options.delay, this.__options.delay]), "number" == typeof this.__options.delayTouch && (this.__options.delayTouch = [this.__options.delayTouch, this.__options.delayTouch]), "string" == typeof this.__options.theme && (this.__options.theme = [this.__options.theme]), null === this.__options.parent ? this.__options.parent = e(r.window.document.body) : "string" == typeof this.__options.parent && (this.__options.parent = e(this.__options.parent)), "hover" == this.__options.trigger ? (this.__options.triggerOpen = {
                    mouseenter: !0,
                    touchstart: !0
            ...
            __prepareOrigin: function() {
                var e = this;
                if (e._$origin.off("." + e.__namespace + "-triggerOpen"), r.hasTouchCapability && e._$origin.on("touchstart." + e.__namespace + "-triggerOpen touchend." + e.__namespace + "-triggerOpen touchcancel." + e.__namespace + "-triggerOpen", function(t) {
                    e._touchRecordEvent(t)
                }), e.__options.triggerOpen.click || e.__options.triggerOpen.tap && r.hasTouchCapability) {
                    var t = "";
                    e.__options.triggerOpen.click && (t += "click." + e.__namespace + "-triggerOpen "), e.__options.triggerOpen.tap && r.hasTouchCapability && (t += "touchend." + e.__namespace + "-triggerOpen"), e._$origin.on(t, function(t) {
                        e._touchIsMeaningfulEvent(t) && e._open(t)
                    })
                }
                if (e.__options.triggerOpen.mouseenter || e.__options.triggerOpen.touchstart && r.hasTouchCapability) {
                    var t = "";
                    e.__options.triggerOpen.mouseenter && (t += "mouseenter." + e.__namespace + "-triggerOpen "), e.__options.triggerOpen.touchstart && r.hasTouchCapability && (t += "touchstart." + e.__namespace + "-triggerOpen"), e._$origin.on(t, function(t) {
                        !e._touchIsTouchEvent(t) && e._touchIsEmulatedEvent(t) || (e.__pointerIsOverOrigin = !0, e._openShortly(t))
                    })
                }
                if (e.__options.triggerClose.mouseleave || e.__options.triggerClose.touchleave && r.hasTouchCapability) {
                    var t = "";
                    e.__options.triggerClose.mouseleave && (t += "mouseleave." + e.__namespace + "-triggerOpen "), e.__options.triggerClose.touchleave && r.hasTouchCapability && (t += "touchend." + e.__namespace + "-triggerOpen touchcancel." + e.__namespace + "-triggerOpen"), e._$origin.on(t, function(t) {
            ...
            __scrollHandler: function(t) {
                ...
                if (i.__options.triggerClose.scroll) i._close(t);
                    ...
                    var o = null;
                    if (t.target === r.window.document) i.__Geometry.origin.fixedLineage || i.__options.repositionOnScroll && i.reposition(t);
                    else {
                        o = i.__geometry();
                        var a = !1;
                        if ("fixed" != i._$origin.css("position") && i.__$originParents.each(function(t, i) {
                            var n = e(i),
                                s = n.css("overflow-x"),
                                r = n.css("overflow-y");
                            if ("visible" != s || "visible" != r) {
                                var l = i.getBoundingClientRect();
                                if ("visible" != s && (o.origin.windowOffset.left < l.left || o.origin.windowOffset.right > l.right)) return a = !0, !1;
                                if ("visible" != r && (o.origin.windowOffset.top < l.top || o.origin.windowOffset.bottom > l.bottom)) return a = !0, !1
                            }
                            if ("fixed" == n.css("position")) return !1
                        }), a) i._$tooltip.css("visibility", "hidden");
                        else if (i._$tooltip.css("visibility", "visible"), i.__options.repositionOnScroll) i.reposition(t);
                        else {
                            var s = o.origin.offset.left - i.__Geometry.origin.offset.left,
                ...
                return e.__options.trackTooltip && (e.__contentBcr = t[0].getBoundingClientRect()), e.__tracker = setInterval(function() {
                    if (n(e._$origin) && n(e._$tooltip)) {
                        if (e.__options.trackOrigin) {
                            var o = e.__geometry(),
                                a = !1;
                            i(o.origin.size, e.__Geometry.origin.size) && (e.__Geometry.origin.fixedLineage ? i(o.origin.windowOffset, e.__Geometry.origin.windowOffset) && (a = !0) : i(o.origin.offset, e.__Geometry.origin.offset) && (a = !0)), a || (e.__options.triggerClose.mouseleave ? e._close() : e.reposition())
                        }
                ...
                if (o._trigger({
                    ...
                    if ("closed" != o.__state) {
                        var l = !0,
                            c = new Date,
                            p = c.getTime(),
                            d = p + o.__options.animationDuration[1];
                        if ("disappearing" == o.__state && d > o.__closingTime && o.__options.animationDuration[1] > 0 && (l = !1), l) {
                            ...
                            var u = function() {
                                clearInterval(o.__tracker), o._trigger({
                                    type: "closing",
                                    event: t
                                }), o._$tooltip.off("." + o.__namespace + "-triggerClose").removeClass("tooltipster-dying"), e(r.window).off("." + o.__namespace + "-triggerClose"), o.__$originParents.each(function(t, i) {
                                    e(i).off("scroll." + o.__namespace + "-triggerClose")
                                }), o.__$originParents = null, e(r.window.document.body).off("." + o.__namespace + "-triggerClose"), o._$origin.off("." + o.__namespace + "-triggerClose"), o._off("dismissable"), o.__stateSet("closed"), o._trigger({
                                    type: "after",
                                    event: t
            ...
            _open: function(t, i) {
                ...
                if (!o.__destroying && n(o._$origin) && o.__enabled) {
                    ...
                    if ("closed" == o.__state && (o._trigger({
                    ...
                    }), a && o.__options.functionBefore && (a = o.__options.functionBefore.call(o, o, {
                        event: t,
                        origin: o._$origin[0]
                    }))), a !== !1 && null !== o.__Content) {
                        ...
                        if ("closed" !== o.__state) s = 0, "disappearing" === o.__state ? (o.__stateSet("appearing"), r.hasTransitions ? (o._$tooltip.clearQueue().removeClass("tooltipster-dying").addClass("tooltipster-show"), o.__options.animationDuration[0] > 0 && o._$tooltip.delay(o.__options.animationDuration[0]), o._$tooltip.queue(l)) : o._$tooltip.stop().fadeIn(l)) : "stable" == o.__state && l();
                        else {
                            if (o.__stateSet("appearing"), s = o.__options.animationDuration[0], o.__contentInsert(), o.reposition(t, !0), r.hasTransitions ? (o._$tooltip.addClass("tooltipster-" + o.__options.animation).addClass("tooltipster-initial").css({
                            ...
                            }, 0)) : o._$tooltip.css("display", "none").fadeIn(o.__options.animationDuration[0], l), o.__trackerStart(), e(r.window).on("resize." + o.__namespace + "-triggerClose", function(t) {
                                ...
                                o._on("dismissable", function(e) {
                                    e.dismissable ? e.delay ? (u = setTimeout(function() {
                                        o._close(e.event)
                                    }, e.delay), o.__timeouts.close.push(u)) : o._close(e) : clearTimeout(u)
                                });
                                var c = o._$origin,
                                    p = "",
                                    d = "",
                                    u = null;
                                o.__options.interactive && (c = c.add(o._$tooltip)), o.__options.triggerClose.mouseleave && (p += "mouseenter." + o.__namespace + "-triggerClose ", d += "mouseleave." + o.__namespace + "-triggerClose "), o.__options.triggerClose.touchleave && r.hasTouchCapability && (p += "touchstart." + o.__namespace + "-triggerClose", d += "touchend." + o.__namespace + "-triggerClose touchcancel." + o.__namespace + "-triggerClose"), c.on(d, function(e) {
                            ...
                            o.__options.triggerClose.originClick && o._$origin.on("click." + o.__namespace + "-triggerClose", function(e) {
                                ...
                                if ("closed" != o.__state) {
                                    ...
                                    o.__options.triggerClose.click && (t += "click." + o.__namespace + "-triggerClose "), o.__options.triggerClose.tap && r.hasTouchCapability && (t += "touchend." + o.__namespace + "-triggerClose"), i.on(t, function(t) {
                                        o._touchIsMeaningfulEvent(t) && (o._touchRecordEvent(t), o.__options.interactive && e.contains(o._$tooltip[0], t.target) || o._close(t))
                                    }), o.__options.triggerClose.tap && r.hasTouchCapability && i.on("touchstart." + o.__namespace + "-triggerClose", function(e) {
            ...
            _optionsExtract: function(t, i) {
                var n = this,
                    o = e.extend(!0, {}, i),
                    a = n.__options[t];
                return a || (a = {}, e.each(i, function(e, t) {
                    var i = n.__options[e];
                    void 0 !== i && (a[e] = i)
                })), e.each(o, function(t, i) {
                    void 0 !== a[t] && ("object" != typeof i || i instanceof Array || null == i || "object" != typeof a[t] || a[t] instanceof Array || null == a[t] ? o[t] = a[t] : e.extend(o[t], a[t]))
                }), o
            },
            _plug: function(t) {
            ...
            destroy: function() {
                ...
                if (t.__destroyed) t.__destroyError();
                    ...
                    "closed" != t.__state ? t.option("animationDuration", 0)._close(null, null, !0) : t.__timeoutsClear(), t._trigger("destroy"), t.__destroyed = !0, t._$origin.removeData(t.__namespace).off("." + t.__namespace + "-triggerOpen"), e(r.window.document.body).off("." + t.__namespace + "-triggerOpen");
            ...
            if ("string" == typeof t[0]) {
                ...
                return this.each(function() {
                    var o = e(this).data("tooltipster-ns"),
                        a = o ? e(this).data(o[0]) : null;
                    if (!a) throw new Error("You called Tooltipster's \"" + t[0] + '" method on an uninitialized element');
                    if ("function" != typeof a[t[0]]) throw new Error('Unknown method "' + t[0] + '"');
                    this.length > 1 && "content" == t[0] && (t[1] instanceof e || "object" == typeof t[1] && null != t[1] && t[1].tagName) && !a.__options.contentCloning && a.__options.debug && console.log(i);
                    var s = a[t[0]](t[1], t[2]);
                    if (s !== a || "instance" === t[0]) return n = s, !1
                }), "#*$~&" !== n ? n : this
            }
            e.tooltipster.__instancesLatestArr = [];
            var o = t[0] && void 0 !== t[0].multiple,
                s = o && t[0].multiple || !o && a.multiple,
                r = t[0] && void 0 !== t[0].content,
                l = r && t[0].content || !r && a.content,
                c = t[0] && void 0 !== t[0].contentCloning,
                p = c && t[0].contentCloning || !c && a.contentCloning,
                d = t[0] && void 0 !== t[0].debug,
                u = d && t[0].debug || !d && a.debug;
            return this.length > 1 && (l instanceof e || "object" == typeof l && null != l && l.tagName) && !p && u && console.log(i), this.each(function() {
                var i = !1,
                    n = e(this),
                    o = n.data("tooltipster-ns"),
                    a = null;
                o ? s ? i = !0 : u && (console.log("Tooltipster: one or more tooltips are already attached to the element below. Ignoring."), console.log(this)) : i = !0, i && (a = new e.Tooltipster(this, t[0]), o || (o = []), o.push(a.__namespace), n.data("tooltipster-ns", o), n.data(a.__namespace, a), a.__options.functionInit && a.__options.functionInit.call(a, a, {
                    origin: this
                }), a._trigger("init")), e.tooltipster.__instancesLatestArr.push(a)
            }), this
        }, t.prototype = {
            __init: function(t) {
                this.__$tooltip = t, this.__$tooltip.css({
                    ...
                    position: "absolute",
                    top: 0
                }).find(".tooltipster-content").css("overflow", "auto"), this.$container = e('<div class="tooltipster-ruler"></div>').append(this.__$tooltip).appendTo(r.window.document.body)
            },
            ...
            measure: function() {
                ...
                return r.IE && r.IE <= 11 && t.size.width !== r.window.document.documentElement.clientWidth && (t.size.width = Math.ceil(t.size.width) + 1), t
            }
        };
        var c = navigator.userAgent.toLowerCase();
        c.indexOf("msie") != -1 ? r.IE = parseInt(c.split("msie")[1]) : c.toLowerCase().indexOf("trident") !== -1 && c.indexOf(" rv:11") !== -1 ? r.IE = 11 : c.toLowerCase().indexOf("edge/") != -1 && (r.IE = parseInt(c.toLowerCase().split("edge/")[1]));
        var p = "tooltipster.sideTip";
        return e.tooltipster._plugin({
            ...
            instance: {
                ...
                __optionsFormat: function() {
                    var t = this;
                    if (t.__options = t.__instance._optionsExtract(p, t.__defaults()), t.__options.position && (t.__options.side = t.__options.position), "object" != typeof t.__options.distance && (t.__options.distance = [t.__options.distance]), t.__options.distance.length < 4 && (void 0 === t.__options.distance[1] && (t.__options.distance[1] = t.__options.distance[0]), void 0 === t.__options.distance[2] && (t.__options.distance[2] = t.__options.distance[0]), void 0 === t.__options.distance[3] && (t.__options.distance[3] = t.__options.distance[1]), t.__options.distance = {
                ...
                __reposition: function(t, i) {
                    ...
                    var r = o.__instance._$tooltip.clone(),
                        l = e.tooltipster._getRuler(r),
                        c = !1,
                        p = o.__instance.option("animation");
                    switch (p && r.removeClass("tooltipster-" + p), e.each(["window", "document"], function(n, p) {
                        var d = null;
                        if (o.__instance._trigger({
                            ...
                            results: s,
                            type: "positionTest"
                        }), 1 == d || 0 != d && 0 == c && ("window" != p || o.__options.viewportAware))
                            for (var n = 0; n < o.__options.side.length; n++) {
                                var u = {
                                        horizontal: 0,
                                        vertical: 0
                                    },
                                    h = o.__options.side[n];
                                "top" == h || "bottom" == h ? u.vertical = o.__options.distance[h] : u.horizontal = o.__options.distance[h], o.__sideChange(r, h), e.each(["natural", "constrained"], function(e, n) {
                                    if (d = null, o.__instance._trigger({
                                        ...
                                        var r = {
                                            ...
                                            f = "natural" == n ? l.free() : l.constrain(i.geo.available[p][h].width - u.horizontal, i.geo.available[p][h].height - u.vertical),
                                            g = f.measure();
                                        if (r.size = g.size, r.outerSize = {
                                            height: g.size.height + u.vertical,
                                            width: g.size.width + u.horizontal
                                        }, "natural" == n ? i.geo.available[p][h].width >= r.outerSize.width && i.geo.available[p][h].height >= r.outerSize.height ? r.fits = !0 : r.fits = !1 : r.fits = g.fits, "window" == p && (r.fits ? r.whole = "top" == h || "bottom" == h ? i.geo.origin.windowOffset.right >= o.__options.minIntersection && i.geo.window.size.width - i.geo.origin.windowOffset.left >= o.__options.minIntersection : i.geo.origin.windowOffset.bottom >= o.__options.minIntersection && i.geo.window.size.height - i.geo.origin.windowOffset.top >= o.__options.minIntersection : r.whole = !1), s.push(r), r.whole) c = !0;
                                        else if ("natural" == r.mode && (r.fits || r.size.width <= i.geo.available[p][h].width)) return !1
                                    }
                                })
                            }
                        ...
                        if (!e.whole && t.whole) return 1;
                        if (e.whole && t.whole) {
                            var i = o.__options.side.indexOf(e.side),
                                n = o.__options.side.indexOf(t.side);
                            return i < n ? -1 : i > n ? 1 : "natural" == e.mode ? -1 : 1
                        }
                    ...
                    if (o.__instance._trigger({
                        ...
                        var u = o.__options.functionPosition.call(o, o.__instance, i, d);
                        u && (n = u)
                    }
                    l.destroy();
                    var h, f;
                    "top" == n.side || "bottom" == n.side ? (h = {
                        prop: "left",
                        val: n.target - n.coord.left
                    }, f = n.size.width - this.__options.minIntersection) : (h = {
                        prop: "top",
                        val: n.target - n.coord.top
                    }, f = n.size.height - this.__options.minIntersection), h.val < this.__options.minIntersection ? h.val = this.__options.minIntersection : h.val > f && (h.val = f);
                    var g;
                    g = i.geo.origin.fixedLineage ? i.geo.origin.windowOffset : {
                        ...
                        left: "",
                        top: ""
                    }).css(h.prop, h.val), o.__instance._$tooltip.appendTo(o.__instance.option("parent")), o.__instance._trigger({
                        type: "repositioned",
                        event: t,
                        position: n
                    })
    ...
    function(e) {
        ...
        t.prototype = {
            ...
            typewrite: function(e, t) {
                if (this.stop !== !0) {
                    ...
                    n.timeout = setTimeout(function() {
                        ...
                        if ("^" === o.charAt(0)) {
                            var a = 1;
                            /^\^\d+/.test(o) && (o = /\d+/.exec(o)[0], a += o.length, i = parseInt(o)), e = e.substring(0, t) + e.substring(t + a)
                        }
                        if ("html" === n.contentType) {
                            ...
                            if ("<" === s || "&" === s) {
                                var r = "",
                                    l = "";
                                for (l = "<" === s ? ">" : ";"; e.substr(t + 1).charAt(0) !== l && (r += e.substr(t).charAt(0), !(++t + 1 > e.length)););
                                t++, r += l
                            }
                        }
                        n.timeout = setTimeout(function() {
                ...
                if (this.stop !== !0) {
                    ...
                    n.timeout = setTimeout(function() {
                        if ("html" === n.contentType && ">" === e.substr(t).charAt(0)) {
                            for (var i = "";
                                 "<" !== e.substr(t - 1).charAt(0) && (i -= e.substr(t).charAt(0), !(0 > --t)););
                            t--, i += "<"
                        }
                        var o = e.substr(0, t);
            ...
            reset: function() {
                var e = this;
                clearInterval(e.timeout), this.el.attr("id"), this.el.empty(), void 0 !== this.cursor && this.cursor.remove(), this.strPos = 0, this.arrayPos = 0, this.curLoop = 0, this.options.resetCallback()
            }
            ...
            return this.each(function() {
                var n = e(this),
                    o = n.data("typed"),
                    a = "object" == typeof i && i;
                o && o.reset(), n.data("typed", o = new t(this, a)), "string" == typeof i && o[i]()
            })
        }, e.fn.typed.defaults = {
